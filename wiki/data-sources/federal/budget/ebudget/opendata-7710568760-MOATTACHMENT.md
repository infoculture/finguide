---
title: "Отчетность администратора доходов иных бюджетов (ф.0503110, 0503121, 0503123, 0503127, 0503130, 0503160, 0503164, 0503169, 0503173)"
sidebar_label: "Отчетность администратора доходов иных бюджетов (ф.050311…"
tags:
  - data-source
  - federal
  - budget
...
slug: '/data-sources/federal/opendata-7710568760-MOATTACHMENT'
source_url: "https://budget.gov.ru/epbs/opendata/7710568760-MOATTACHMENT/meta.json"
...
description: "Отчетность администратора доходов иных бюджетов (ф.0503110, 0503121, 0503123, 0503127, 0503130, 0503160, 0503164, 0503169, 0503173) — именованный открытый набор каталога budget.gov.ru (7710568760-MOATTACHMENT); паспорт набора meta.json и файловые версии в контуре ГИИС «Электронный бюджет»."
...
# Отчетность администратора доходов иных бюджетов (ф.0503110, 0503121, 0503123, 0503127, 0503130, 0503160, 0503164, 0503169, 0503173)
...
Коротко: **Отчетность администратора доходов иных бюджетов (ф.0503110, 0503121, 0503123, 0503127, 0503130, 0503160, 0503164, 0503169, 0503173)** — отдельная запись каталога `list.json` с постоянным идентификатором **`7710568760-MOATTACHMENT`**; для автоматизации начните с паспорта `meta.json` и сверьте поля с задачей анализа (план, факт, НСИ, отчётность и т.д.).
...
| --- | --- | --- |
| Карточка набора (витрина) | https://budget.gov.ru/epbs/faces/p/%D0%94%D0%B0%D0%BD%D0%BD%D1%8B%D0%B5%20%D0%B8%20%D1%81%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D1%8B/opendata?code=7710568760-MOATTACHMENT | HTML |
| Паспорт набора | https://budget.gov.ru/epbs/opendata/7710568760-MOATTACHMENT/meta.json | JSON |
...
```bash
curl -sS -A "Mozilla/5.0" "https://budget.gov.ru/epbs/opendata/7710568760-MOATTACHMENT/meta.json" | python3 -m json.tool | head -60
```
