---
title: "Перечень мероприятий объекта государственного (муниципального) финансового контроля по исправлению выявленных органами государственного (муниципального) контроля бюджетных нарушений"
sidebar_label: "Перечень мероприятий объекта государственного (муниципаль…"
tags:
  - data-source
  - federal
  - budget
...
slug: '/data-sources/federal/opendata-7710568760-MEROPRIYATIYAAUDITA'
source_url: "https://budget.gov.ru/epbs/opendata/7710568760-MEROPRIYATIYAAUDITA/meta.json"
...
description: "Перечень мероприятий объекта государственного (муниципального) финансового контроля по исправлению выявленных органами государственного (муниципального) контроля бюджетных нарушений — именованный открытый набор каталога budget.gov.ru (7710568760-MEROPRIYATIYAAUDITA); паспорт набора meta.json и файловые версии в контуре ГИИС «Электронный бюджет»."
...
# Перечень мероприятий объекта государственного (муниципального) финансового контроля по исправлению выявленных органами государственного (муниципального) контроля бюджетных нарушений
...
Коротко: **Перечень мероприятий объекта государственного (муниципального) финансового контроля по исправлению выявленных органами государственного (муниципального) контроля бюджетных нарушений** — отдельная запись каталога `list.json` с постоянным идентификатором **`7710568760-MEROPRIYATIYAAUDITA`**; для автоматизации начните с паспорта `meta.json` и сверьте поля с задачей анализа (план, факт, НСИ, отчётность и т.д.).
...
| --- | --- | --- |
| Карточка набора (витрина) | https://budget.gov.ru/epbs/faces/p/%D0%94%D0%B0%D0%BD%D0%BD%D1%8B%D0%B5%20%D0%B8%20%D1%81%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D1%8B/opendata?code=7710568760-MEROPRIYATIYAAUDITA | HTML |
| Паспорт набора | https://budget.gov.ru/epbs/opendata/7710568760-MEROPRIYATIYAAUDITA/meta.json | JSON |
...
```bash
curl -sS -A "Mozilla/5.0" "https://budget.gov.ru/epbs/opendata/7710568760-MEROPRIYATIYAAUDITA/meta.json" | python3 -m json.tool | head -60
```
