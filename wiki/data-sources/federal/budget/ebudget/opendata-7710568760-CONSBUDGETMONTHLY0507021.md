...
slug: '/data-sources/federal/opendata-7710568760-CONSBUDGETMONTHLY0507021'
source_url: "https://budget.gov.ru/epbs/opendata/7710568760-CONSBUDGETMONTHLY0507021/meta.json"
...
description: "Информация о доходах, расходах и источниках финансирования дефицита консолидированного бюджета Российской Федерации и бюджетов государственных внебюджетных фондов Российской Федерации по кодам бюджетной классификации на  — именованный открытый набор каталога budget.gov.ru (7710568760-CONSBUDGETMONTHLY0507021); паспорт набора meta.json и файловые версии в контуре ГИИС «Электронный бюджет»."
...
Коротко: **Информация о доходах, расходах и источниках финансирования дефицита консолидированного бюджета Российской Федерации и бюджетов государственных внебюджетных фондов Российской Федерации по кодам бюджетной классификации на отчетную дату нарастающим итогом с начала года** — отдельная запись каталога `list.json` с постоянным идентификатором **`7710568760-CONSBUDGETMONTHLY0507021`**; для автоматизации начните с паспорта `meta.json` и сверьте поля с задачей анализа (план, факт, НСИ, отчётность и т.д.).
...
| --- | --- | --- |
| Карточка набора (витрина) | https://budget.gov.ru/epbs/faces/p/%D0%94%D0%B0%D0%BD%D0%BD%D1%8B%D0%B5%20%D0%B8%20%D1%81%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D1%8B/opendata?code=7710568760-CONSBUDGETMONTHLY0507021 | HTML |
| Паспорт набора | https://budget.gov.ru/epbs/opendata/7710568760-CONSBUDGETMONTHLY0507021/meta.json | JSON |
...
```bash
curl -sS -A "Mozilla/5.0" "https://budget.gov.ru/epbs/opendata/7710568760-CONSBUDGETMONTHLY0507021/meta.json" | python3 -m json.tool | head -60
```
