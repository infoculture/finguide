---
title: >-
  Ямало-Ненецкий автономный округ: Управление Федерального казначейства по
  Ямало-Ненецкому автономному округу
sidebar_label: Управление Федерального казначейства по Ямало-Ненецк
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/yamalo-nenets-autonomous-okrug-fin-12b7c8f14b
source_url: 'https://yamalo-nenetskiy.roskazna.gov.ru/'
...
description: >-
  ...
  управление Федерального казначейства): Обеспечение наличными денежными
  средствами, централизованный бюджетный учет и отчетность, учет и распределение
  поступлений, открытие и веден
...
# Ямало-Ненецкий автономный округ: Управление Федерального казначейства по Ямало-Ненецкому автономному округу
...
| Оператор | Управление Федерального казначейства по Ямало-Ненецкому автономному округу |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Обеспечение наличными денежными средствами, централизованный бюджетный учет и отчетность, учет и распределение поступлений, открытие и ведение лицевых счетов
...
**Комментарий:** Официальный сайт с информацией о казначейских операциях.

## Оператор

Управление Федерального казначейства по Ямало-Ненецкому автономному округу — канонический вход: https://yamalo-nenetskiy.roskazna.gov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://yamalo-nenetskiy.roskazna.gov.ru/ | HTML |

## Объекты данных и показатели

- Обеспечение наличными денежными средствами, централизованный бюджетный учет и отчетность, учет и распределение поступлений, открытие и ведение лицевых счетов
