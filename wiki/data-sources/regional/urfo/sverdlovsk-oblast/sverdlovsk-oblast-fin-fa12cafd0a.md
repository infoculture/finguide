---
title: 'Свердловская область: Открытый бюджет Свердловской области'
...
slug: /data-sources/regional/sverdlovsk-oblast-fin-fa12cafd0a
...
description: >-
  ...
  для граждан): Областной бюджет, бюджет для граждан, исполнение бюджета
...
# Свердловская область: Открытый бюджет Свердловской области
...
| Оператор | Открытый бюджет Свердловской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Областной бюджет, бюджет для граждан, исполнение бюджета
...
**Комментарий:** Специализированный портал по открытому бюджету.

## Оператор

Открытый бюджет Свердловской области — канонический вход: http://smart.mfural.ru/ebudget

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://smart.mfural.ru/ebudget | HTML |

## Объекты данных и показатели

- Областной бюджет, бюджет для граждан, исполнение бюджета
