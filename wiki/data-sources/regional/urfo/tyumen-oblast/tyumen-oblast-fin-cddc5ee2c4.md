---
title: >-
  Тюменская область: Официальный портал органов государственной власти Тюменской
  области, раздел "Бюджет для граждан"
sidebar_label: Официальный портал органов государственной власти Тю
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/tyumen-oblast-fin-cddc5ee2c4
source_url: 'https://admtyumen.ru/ogv_ru/finance/finance/citizens_budget.htm'
...
description: >-
  ...
  для граждан): Информационный ресурс, разработанный для ознакомления граждан с
  основными целями, задачами и приоритетными направлениями бюджета.
...
# Тюменская область: Официальный портал органов государственной власти Тюменской области, раздел "Бюджет для граждан"
...
| Оператор | Официальный портал органов государственной власти Тюменской области, раздел "Бюджет для граждан" |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информационный ресурс, разработанный для ознакомления граждан с основными целями, задачами и приоритетными направлениями бюджета.
...
**Комментарий:** Раздел "Бюджет для граждан" на официальном портале органов государственной власти Тюменской области.

## Оператор

Официальный портал органов государственной власти Тюменской области, раздел "Бюджет для граждан" — канонический вход: https://admtyumen.ru/ogv_ru/finance/finance/citizens_budget.htm

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://admtyumen.ru/ogv_ru/finance/finance/citizens_budget.htm | HTML |

## Объекты данных и показатели

- Информационный ресурс, разработанный для ознакомления граждан с основными целями, задачами и приоритетными направлениями бюджета.
