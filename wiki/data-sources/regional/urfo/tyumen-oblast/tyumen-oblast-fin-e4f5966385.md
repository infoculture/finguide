---
title: 'Тюменская область: Правовые акты Тюменской области'
sidebar_label: Правовые акты Тюменской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/tyumen-oblast-fin-e4f5966385
source_url: 'https://tyumen-pravo.ru/'
...
description: >-
  ...
  база): Сборник законов и других нормативно-правовых документов Тюменской
  области.
...
# Тюменская область: Правовые акты Тюменской области
...
| Оператор | Правовые акты Тюменской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Сборник законов и других нормативно-правовых документов Тюменской области.
...
**Комментарий:** Информационно-правовой портал.

## Оператор

Правовые акты Тюменской области — канонический вход: https://tyumen-pravo.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://tyumen-pravo.ru/ | HTML |

## Объекты данных и показатели

- Сборник законов и других нормативно-правовых документов Тюменской области.
