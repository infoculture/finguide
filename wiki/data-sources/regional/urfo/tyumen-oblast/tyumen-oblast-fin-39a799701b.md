---
title: 'Тюменская область: Счетная палата Тюменской области'
sidebar_label: Счетная палата Тюменской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/tyumen-oblast-fin-39a799701b
...
description: >-
  ...
  госфинансам): Результаты контрольной деятельности, отчеты о проверках
...
# Тюменская область: Счетная палата Тюменской области
...
| Оператор | Счетная палата Тюменской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Результаты контрольной деятельности, отчеты о проверках использования бюджетных средств.
...
Счетная палата Тюменской области — канонический вход: https://rfspto.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://rfspto.ru/ | HTML |

## Объекты данных и показатели

- Результаты контрольной деятельности, отчеты о проверках использования бюджетных средств.
