---
title: >-
  Ханты-Мансийский автономный округ — Югра: Раздел «Открытый бюджет» и «Бюджет
  для граждан» на сайте Департамента финансов ХМАО – Югры
sidebar_label: Раздел «Открытый бюджет» и «Бюджет для граждан» на с
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/khanty-mansi-autonomous-okrug-yugra-fin-a3b0d85fe2
...
description: >-
  ...
  для граждан): Информация о формировании и исполнении бюджета в доступной форме
  для граждан
...
# Ханты-Мансийский автономный округ — Югра: Раздел «Открытый бюджет» и «Бюджет для граждан» на сайте Департамента финансов ХМАО – Югры
...
| Оператор | Раздел «Открытый бюджет» и «Бюджет для граждан» на сайте Департамента финансов ХМАО – Югры |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о формировании и исполнении бюджета в доступной форме для граждан
...
**Комментарий:** Отдельный раздел на сайте Департамента финансов

## Оператор

Раздел «Открытый бюджет» и «Бюджет для граждан» на сайте Департамента финансов ХМАО – Югры — канонический вход: https://depfin.admhmao.ru/activity/otkrytyy-byudzhet

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://depfin.admhmao.ru/activity/otkrytyy-byudzhet | HTML |

## Объекты данных и показатели

- Информация о формировании и исполнении бюджета в доступной форме для граждан
