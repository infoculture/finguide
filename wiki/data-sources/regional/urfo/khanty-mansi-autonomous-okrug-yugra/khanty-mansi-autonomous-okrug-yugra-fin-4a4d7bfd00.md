---
title: >-
  Ханты-Мансийский автономный округ — Югра: Единая информационная система в
  сфере закупок (zakupki.gov.ru)
sidebar_label: Единая информационная система в сфере закупок (zakup
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/khanty-mansi-autonomous-okrug-yugra-fin-4a4d7bfd00
source_url: >-
  https://zakupki.gov.ru/epz/organization/view/info.html?organizationCode=01872000017
...
description: >-
  ...
  региональным разрезом): Информация о государственных и муниципальных закупках
  с региональным разрезом
...
# Ханты-Мансийский автономный округ — Югра: Единая информационная система в сфере закупок (zakupki.gov.ru)
...
| Оператор | Единая информационная система в сфере закупок (zakupki.gov.ru) |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о государственных и муниципальных закупках с региональным разрезом
...
**Категория (таблица):** Дополнительные официальные источники по госфинансам: федеральные витрины с региональным разрезом

**Статус исследования:** найдено

**Комментарий:** Федеральный портал госзакупок с возможностью фильтрации по региону

## Оператор

Единая информационная система в сфере закупок (zakupki.gov.ru) — канонический вход: https://zakupki.gov.ru/epz/organization/view/info.html?organizationCode=01872000017

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://zakupki.gov.ru/epz/organization/view/info.html?organizationCode=01872000017 | HTML |

## Объекты данных и показатели

- Информация о государственных и муниципальных закупках с региональным разрезом
