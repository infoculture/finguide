---
title: 'Ханты-Мансийский автономный округ — Югра: Портал открытых данных Югры'
sidebar_label: Портал открытых данных Югры
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/khanty-mansi-autonomous-okrug-yugra-fin-8dbee089fe
...
description: >-
  ...
  Различные наборы данных, включая финансовые
...
# Ханты-Мансийский автономный округ — Югра: Портал открытых данных Югры
...
**Категория (таблица):** Дополнительные официальные источники по госфинансам: портал открытых данных

**Статус исследования:** найдено

**Комментарий:** Официальный портал открытых данных

## Оператор

Портал открытых данных Югры — канонический вход: https://data.admhmao.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://data.admhmao.ru/ | HTML |
