---
title: 'Рязанская область: Портал закупок Рязанской области'
sidebar_label: Портал закупок Рязанской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/ryazan-oblast-fin-806e16474f
...
description: >-
  ...
  бюджетные разделы): Государственные закупки Рязанской области
...
# Рязанская область: Портал закупок Рязанской области
...
Портал закупок Рязанской области — канонический вход: https://czro.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://czro.ru/ | HTML |

## Объекты данных и показатели

- Государственные закупки Рязанской области
