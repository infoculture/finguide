---
title: 'Московская область: Открытый бюджет Московской области'
sidebar_label: Открытый бюджет Московской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/moscow-oblast-fin-b314300d7d
...
description: >-
  ...
  для граждан): Бюджет для граждан, аналитика
...
# Московская область: Открытый бюджет Московской области
...
**Комментарий:** Специализированный портал с бюджетной информацией для граждан.

## Оператор

Открытый бюджет Московской области — канонический вход: https://budget.mosreg.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://budget.mosreg.ru/ | HTML |

## Объекты данных и показатели

- Бюджет для граждан, аналитика
