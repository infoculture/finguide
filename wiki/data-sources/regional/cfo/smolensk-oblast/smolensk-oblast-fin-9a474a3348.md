---
title: 'Смоленская область: Нормативно-правовые документы Смоленской области'
sidebar_label: Нормативно-правовые документы Смоленской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/smolensk-oblast-fin-9a474a3348
...
description: >-
  ...
  база): Законы, постановления, приказы
...
# Смоленская область: Нормативно-правовые документы Смоленской области
...
**Комментарий:** Раздел на портале администрации

## Оператор

Нормативно-правовые документы Смоленской области — канонический вход: https://rek.admin-smolensk.ru/docs/npd_smol

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://rek.admin-smolensk.ru/docs/npd_smol | HTML |
