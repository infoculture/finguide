---
title: 'Курская область: Интернет-портал правовой информации Курской области'
sidebar_label: Интернет-портал правовой информации Курской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/kursk-oblast-fin-1efe8fdcf6
...
description: >-
  ...
  база): Официальное опубликование нормативных правовых актов Курской области.
...
# Курская область: Интернет-портал правовой информации Курской области
...
| Оператор | Интернет-портал правовой информации Курской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Официальное опубликование нормативных правовых актов Курской области.
...
Интернет-портал правовой информации Курской области — канонический вход: https://kurskpravo.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://kurskpravo.ru/ | HTML |

## Объекты данных и показатели

- Официальное опубликование нормативных правовых актов Курской области.
