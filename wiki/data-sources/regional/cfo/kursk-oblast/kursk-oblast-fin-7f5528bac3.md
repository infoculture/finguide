---
title: 'Курская область: Контрольно-счетная палата Курской области'
sidebar_label: Контрольно-счетная палата Курской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/kursk-oblast-fin-7f5528bac3
...
description: >-
  ...
  госфинансам): Отчеты о контрольных мероприятиях, заключения на проекты
  бюджетов, информация о государственном финансовом контроле.
...
# Курская область: Контрольно-счетная палата Курской области
...
| Оператор | Контрольно-счетная палата Курской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Отчеты о контрольных мероприятиях, заключения на проекты бюджетов, информация о государственном финансовом контроле.
...
Контрольно-счетная палата Курской области — канонический вход: https://ksp.kursk.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://ksp.kursk.ru/ | HTML |

## Объекты данных и показатели

- Отчеты о контрольных мероприятиях, заключения на проекты бюджетов, информация о государственном финансовом контроле.
