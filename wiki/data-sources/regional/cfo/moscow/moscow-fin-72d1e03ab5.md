---
title: 'город Москва: Портал Правительства Москвы «Открытый бюджет города Москвы»'
...
slug: /data-sources/regional/moscow-fin-72d1e03ab5
...
description: >-
  ...
  для граждан): Информация по планированию и реализации бюджетной политики
  города Москвы, основные параметры бюджета, структура доходов и расходов
  бюджета.
...
| Оператор | Портал Правительства Москвы «Открытый бюджет города Москвы» |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация по планированию и реализации бюджетной политики города Москвы, основные параметры бюджета, структура доходов и расходов бюджета.
...
**Комментарий:** Официальный портал "Открытый бюджет города Москвы".

## Оператор

Портал Правительства Москвы «Открытый бюджет города Москвы» — канонический вход: https://budget.mos.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://budget.mos.ru/ | HTML |

## Объекты данных и показатели

- Информация по планированию и реализации бюджетной политики города Москвы, основные параметры бюджета, структура доходов и расходов бюджета.
