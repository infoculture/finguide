---
title: >-
  город Москва: Департамент финансов города Москвы (раздел Внутренний финансовый
  аудит и ведомственный контроль)
sidebar_label: Департамент финансов города Москвы (раздел Внутренни
tags:
  - data-source
  - regional
  - control
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/moscow-fin-ec9dce7107
...
description: >-
  ...
  контроль): Информация о внутреннем финансовом аудите и ведомственном контроле.
...
# город Москва: Департамент финансов города Москвы (раздел Внутренний финансовый аудит и ведомственный контроль)
...
| Оператор | Департамент финансов города Москвы (раздел Внутренний финансовый аудит и ведомственный контроль) |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о внутреннем финансовом аудите и ведомственном контроле.
...
**Комментарий:** Раздел на сайте Департамента финансов города Москвы.

## Оператор

Департамент финансов города Москвы (раздел Внутренний финансовый аудит и ведомственный контроль) — канонический вход: https://www.mos.ru/findep/documents

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://www.mos.ru/findep/documents | HTML |

## Объекты данных и показатели

- Информация о внутреннем финансовом аудите и ведомственном контроле.
