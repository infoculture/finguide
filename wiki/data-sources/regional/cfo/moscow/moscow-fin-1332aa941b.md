---
title: >-
  город Москва: Портал Правительства Москвы «Открытый бюджет города Москвы»
  (раздел Государственные программы)
sidebar_label: 'Портал Правительства Москвы «Открытый бюджет города '
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/moscow-fin-1332aa941b
...
description: >-
  ...
  программы): Информация о государственных программах города Москвы, их
  паспортах и реализации.
...
# город Москва: Портал Правительства Москвы «Открытый бюджет города Москвы» (раздел Государственные программы)
...
| Оператор | Портал Правительства Москвы «Открытый бюджет города Москвы» (раздел Государственные программы) |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о государственных программах города Москвы, их паспортах и реализации.
...
**Комментарий:** Раздел государственных программ на портале "Открытый бюджет города Москвы".

## Оператор

Портал Правительства Москвы «Открытый бюджет города Москвы» (раздел Государственные программы) — канонический вход: https://budget.mos.ru/budget/gp/passports

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://budget.mos.ru/budget/gp/passports | HTML |

## Объекты данных и показатели

- Информация о государственных программах города Москвы, их паспортах и реализации.
