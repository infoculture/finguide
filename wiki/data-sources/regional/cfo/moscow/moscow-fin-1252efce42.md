---
title: 'город Москва: Портал открытых данных Правительства Москвы'
sidebar_label: Портал открытых данных Правительства Москвы
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/moscow-fin-1252efce42
...
description: >-
  ...
  Открытые данные Правительства Москвы, включая данные по бюджету и финансам.
...
# город Москва: Портал открытых данных Правительства Москвы
...
| Оператор | Портал открытых данных Правительства Москвы |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Открытые данные Правительства Москвы, включая данные по бюджету и финансам.
...
**Комментарий:** Официальный портал открытых данных города Москвы.

## Оператор

Портал открытых данных Правительства Москвы — канонический вход: https://data.mos.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://data.mos.ru/ | HTML |
