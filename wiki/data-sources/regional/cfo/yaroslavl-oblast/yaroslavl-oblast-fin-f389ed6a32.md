---
title: 'Ярославская область: Открытый бюджет Ярославской области'
sidebar_label: Открытый бюджет Ярославской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/yaroslavl-oblast-fin-f389ed6a32
...
description: >-
  ...
  для граждан): Бюджет для граждан, аналитика, расходы/доходы
...
# Ярославская область: Открытый бюджет Ярославской области
...
**Комментарий:** Специализированный портал открытого бюджета

## Оператор

Открытый бюджет Ярославской области — канонический вход: https://budget76.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://budget76.ru/ | HTML |

## Объекты данных и показатели

- Бюджет для граждан, аналитика, расходы/доходы
