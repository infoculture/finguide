---
title: 'Ярославская область: Министерство финансов Ярославской области'
sidebar_label: Министерство финансов Ярославской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/yaroslavl-oblast-fin-a1b4294fed
...
description: >-
  ...
  субъекта): Информация о бюджете, отчетность, документы
...
# Ярославская область: Министерство финансов Ярославской области
...
Коротко: Информация о бюджете, отчетность, документы
...
**Категория (таблица):** 1. Финансовый орган

**Статус исследования:** найдено

**Комментарий:** Официальный сайт министерства на портале региона
...
| --- | --- | --- |
| Веб | https://portal.yarregion.ru/depts-depfin | HTML |

## Объекты данных и показатели

- Информация о бюджете, отчетность, документы
