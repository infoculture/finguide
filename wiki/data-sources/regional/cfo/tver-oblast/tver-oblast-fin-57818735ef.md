---
title: 'Тверская область: Министерство финансов Тверской области (раздел НПА)'
sidebar_label: Министерство финансов Тверской области (раздел НПА)
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/tver-oblast-fin-57818735ef
...
description: >-
  ...
  база): Проекты и действующие нормативные правовые акты в финансовой сфере
...
# Тверская область: Министерство финансов Тверской области (раздел НПА)
...
| Оператор | Министерство финансов Тверской области (раздел НПА) |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Проекты и действующие нормативные правовые акты в финансовой сфере
...
**Комментарий:** Раздел на сайте Минфина Тверской области

## Оператор

Министерство финансов Тверской области (раздел НПА) — канонический вход: https://www.tverfin.ru/np-baza/regionalnye-normativnye-pravovye-akty

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://www.tverfin.ru/np-baza/regionalnye-normativnye-pravovye-akty | HTML |

## Объекты данных и показатели

- Проекты и действующие нормативные правовые акты в финансовой сфере
