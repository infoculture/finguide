---
title: 'Тверская область: Контрольно-счетная палата Тверской области'
sidebar_label: Контрольно-счетная палата Тверской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/tver-oblast-fin-3335415dd0
...
description: >-
  ...
  госфинансам): Информация о контроле за исполнением бюджета
...
# Тверская область: Контрольно-счетная палата Тверской области
...
| Оператор | Контрольно-счетная палата Тверской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о контроле за исполнением бюджета
...
**Комментарий:** Официальный сайт Контрольно-счетной палаты Тверской области

## Оператор

Контрольно-счетная палата Тверской области — канонический вход: https://ks-region69.com/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://ks-region69.com/ | HTML |

## Объекты данных и показатели

- Информация о контроле за исполнением бюджета
