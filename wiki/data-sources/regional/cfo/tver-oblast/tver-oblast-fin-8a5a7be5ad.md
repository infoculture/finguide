---
title: 'Тверская область: Администрация города Твери (раздел Бюджет)'
sidebar_label: Администрация города Твери (раздел Бюджет)
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/tver-oblast-fin-8a5a7be5ad
...
description: >-
  ...
  госфинансам): Информация о бюджете города Твери, отчеты
...
# Тверская область: Администрация города Твери (раздел Бюджет)
...
**Комментарий:** Раздел на официальном сайте администрации города Твери

## Оператор

Администрация города Твери (раздел Бюджет) — канонический вход: https://www.tver.ru/administration/byudzhet

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://www.tver.ru/administration/byudzhet | HTML |

## Объекты данных и показатели

- Информация о бюджете города Твери, отчеты
