---
title: 'Брянская область: УФК по Брянской области'
...
slug: /data-sources/regional/bryansk-oblast-fin-ce3910ec53
...
description: >-
  ...
  управление Федерального казначейства): Операции федерального казначейства,
...
# Брянская область: УФК по Брянской области
...
| Оператор | УФК по Брянской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Операции федерального казначейства, контроль за исполнением бюджета
...
УФК по Брянской области — канонический вход: https://bryansk.roskazna.gov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://bryansk.roskazna.gov.ru/ | HTML |

## Объекты данных и показатели

- Операции федерального казначейства, контроль за исполнением бюджета
