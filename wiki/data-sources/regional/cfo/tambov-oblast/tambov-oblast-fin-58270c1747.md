---
title: 'Тамбовская область: Контрольно-счетная палата Тамбовской области'
sidebar_label: Контрольно-счетная палата Тамбовской области
tags:
  - data-source
  - regional
  - control
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/tambov-oblast-fin-58270c1747
...
description: >-
  ...
  орган): Годовые отчеты, результаты контрольных мероприятий
...
# Тамбовская область: Контрольно-счетная палата Тамбовской области
...
| Оператор | Контрольно-счетная палата Тамбовской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Годовые отчеты, результаты контрольных мероприятий
...
Контрольно-счетная палата Тамбовской области — канонический вход: https://ksp.tmbreg.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://ksp.tmbreg.ru/ | HTML |

## Объекты данных и показатели

- Годовые отчеты, результаты контрольных мероприятий
