---
title: 'Тамбовская область: Управление Федерального казначейства по Тамбовской области'
sidebar_label: Управление Федерального казначейства по Тамбовской о
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/tambov-oblast-fin-2da8cd696c
...
description: >-
  ...
  управление Федерального казначейства): Новости, пресс-релизы, информация о
  деятельности УФК
...
# Тамбовская область: Управление Федерального казначейства по Тамбовской области
...
Коротко: Новости, пресс-релизы, информация о деятельности УФК
...
**Комментарий:** Основная информация о деятельности, но детальные финансовые данные не подтверждены из-за проблем с доступом к полному содержанию сайта.
...
| --- | --- | --- |
| Веб | https://tambov.roskazna.gov.ru/ | HTML |

## Объекты данных и показатели

- Новости, пресс-релизы, информация о деятельности УФК
