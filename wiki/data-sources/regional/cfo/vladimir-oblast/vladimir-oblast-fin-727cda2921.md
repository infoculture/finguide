---
title: >-
  Владимирская область: Администрация города Владимира (раздел "Бюджет для
  граждан")
sidebar_label: Администрация города Владимира (раздел "Бюджет для г
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/vladimir-oblast-fin-727cda2921
...
description: >-
  ...
  для граждан): Проект "Бюджет для граждан" для города Владимира
...
# Владимирская область: Администрация города Владимира (раздел "Бюджет для граждан")
...
| Оператор | Администрация города Владимира (раздел "Бюджет для граждан") |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Проект "Бюджет для граждан" для города Владимира
...
Администрация города Владимира (раздел "Бюджет для граждан") — канонический вход: https://www.vladimir-city.ru/economics/budget/public

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://www.vladimir-city.ru/economics/budget/public | HTML |

## Объекты данных и показатели

- Проект "Бюджет для граждан" для города Владимира
