---
title: 'Владимирская область: Портал открытых данных города Владимира'
sidebar_label: Портал открытых данных города Владимира
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/vladimir-oblast-fin-b5ffe5b5ce
...
description: >-
  ...
  госфинансам): Наборы данных органов местного самоуправления
...
# Владимирская область: Портал открытых данных города Владимира
...
| Оператор | Портал открытых данных города Владимира |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Наборы данных органов местного самоуправления
...
Портал открытых данных города Владимира — канонический вход: https://www.vladimir-city.ru/opendata

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://www.vladimir-city.ru/opendata | HTML |

## Объекты данных и показатели

- Наборы данных органов местного самоуправления
