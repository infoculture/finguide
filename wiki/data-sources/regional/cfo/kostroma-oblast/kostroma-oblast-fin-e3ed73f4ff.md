---
title: 'Костромская область: Портал НПА Костромской области'
sidebar_label: Портал НПА Костромской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/kostroma-oblast-fin-e3ed73f4ff
...
description: >-
  ...
  база): Законы и нормативные правовые акты Костромской области
...
# Костромская область: Портал НПА Костромской области
...
| Оператор | Портал НПА Костромской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Законы и нормативные правовые акты Костромской области
...
**Комментарий:** Использован агрегатор правовых актов, содержащий региональные документы.

## Оператор

Портал НПА Костромской области — канонический вход: https://docs.cntd.ru/region/44

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://docs.cntd.ru/region/44 | HTML |

## Объекты данных и показатели

- Законы и нормативные правовые акты Костромской области
