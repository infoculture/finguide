---
title: 'Костромская область: Контрольно-счетная палата Костромской области'
sidebar_label: Контрольно-счетная палата Костромской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/kostroma-oblast-fin-f8aa6e24f0
...
description: >-
  ...
  госфинансам): Результаты проверок использования бюджетных средств
...
# Костромская область: Контрольно-счетная палата Костромской области
...
| Оператор | Контрольно-счетная палата Костромской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Результаты проверок использования бюджетных средств
...
Контрольно-счетная палата Костромской области — канонический вход: https://kspkostroma44.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://kspkostroma44.ru/ | HTML |

## Объекты данных и показатели

- Результаты проверок использования бюджетных средств
