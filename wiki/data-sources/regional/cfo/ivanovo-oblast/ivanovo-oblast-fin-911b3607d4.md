---
title: 'Ивановская область: Контрольно-счетная палата Ивановской области'
sidebar_label: Контрольно-счетная палата Ивановской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/ivanovo-oblast-fin-911b3607d4
...
description: >-
  ...
  госфинансам): Отчеты о проверках использования бюджетных средств
...
# Ивановская область: Контрольно-счетная палата Ивановской области
...
| Оператор | Контрольно-счетная палата Ивановской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Отчеты о проверках использования бюджетных средств
...
**Комментарий:** Официальный сайт органа внешнего финансового контроля

## Оператор

Контрольно-счетная палата Ивановской области — канонический вход: https://ksp37.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://ksp37.ru/ | HTML |

## Объекты данных и показатели

- Отчеты о проверках использования бюджетных средств
