---
title: 'Орловская область: Открытый бюджет Орловской области'
...
slug: /data-sources/regional/oryol-oblast-fin-cd9232d2d4
...
description: >-
  ...
  для граждан): Бюджетные данные в открытом формате, информация для граждан
...
# Орловская область: Открытый бюджет Орловской области
...
| Оператор | Открытый бюджет Орловской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Бюджетные данные в открытом формате, информация для граждан
...
**Комментарий:** Портал, управляемый Департаментом финансов

## Оператор

Открытый бюджет Орловской области — канонический вход: http://depfin.orel-region.ru:8096/ebudget

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://depfin.orel-region.ru:8096/ebudget | HTML |

## Объекты данных и показатели

- Бюджетные данные в открытом формате, информация для граждан
