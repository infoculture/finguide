---
title: 'Орловская область: Управление Федерального казначейства по Орловской области'
sidebar_label: Управление Федерального казначейства по Орловской об
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/oryol-oblast-fin-d10c25bd5a
...
description: >-
  ...
  управление Федерального казначейства): Информация о кассовом обслуживании
  исполнения бюджетов, финансовые операции
...
# Орловская область: Управление Федерального казначейства по Орловской области
...
Коротко: Информация о кассовом обслуживании исполнения бюджетов, финансовые операции
...
**Комментарий:** Раздел с финансовыми операциями
...
| --- | --- | --- |
| Веб | https://orel.roskazna.gov.ru/finansovye-operacii | HTML |

## Объекты данных и показатели

- Информация о кассовом обслуживании исполнения бюджетов, финансовые операции
