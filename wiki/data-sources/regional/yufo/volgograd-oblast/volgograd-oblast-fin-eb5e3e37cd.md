---
title: 'Волгоградская область: Волгоградстат'
...
slug: /data-sources/regional/volgograd-oblast-fin-eb5e3e37cd
...
description: >-
  ...
  Росстата): Оперативные статистические показатели, данные по ВРП, заработной
  плате, вводу жилья
...
# Волгоградская область: Волгоградстат
...
| Оператор | Волгоградстат |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Оперативные статистические показатели, данные по ВРП, заработной плате, вводу жилья
...
| --- | --- | --- |
| Веб | https://34.rosstat.gov.ru/ | HTML |

## Объекты данных и показатели

- Оперативные статистические показатели, данные по ВРП, заработной плате, вводу жилья
