---
title: 'Волгоградская область: Интерактивный бюджет для граждан Волгоградской области'
sidebar_label: Интерактивный бюджет для граждан Волгоградской облас
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/volgograd-oblast-fin-4c4e7fb1dd
source_url: 'http://34.interactive-budget.ru/'
...
description: >-
  ...
  для граждан): Интерактивная информация о бюджете, распределение расходов и
  доходов
...
# Волгоградская область: Интерактивный бюджет для граждан Волгоградской области
...
| Оператор | Интерактивный бюджет для граждан Волгоградской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Интерактивная информация о бюджете, распределение расходов и доходов
...
**Комментарий:** Интерактивный портал для ознакомления с бюджетом

## Оператор

Интерактивный бюджет для граждан Волгоградской области — канонический вход: http://34.interactive-budget.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://34.interactive-budget.ru/ | HTML |

## Объекты данных и показатели

- Интерактивная информация о бюджете, распределение расходов и доходов
