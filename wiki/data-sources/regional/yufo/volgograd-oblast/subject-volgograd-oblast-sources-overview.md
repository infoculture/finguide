---
title: "Волгоградская область: источники данных (сводная страница)"
sidebar_label: "Волгоградская область"
tags:
  - data-source
  - regional
...
description: >-
  Сводная навигация по карточкам источников данных wiki для Волгоградская область: прямые ссылки на
  опубликованные витрины и контекст поиска по региональному контуру.
slug: /data-sources/regional/subject-volgograd-oblast-sources-overview
related_pages:
...
# Волгоградская область: источники данных
...
- [Южный федеральный округ](/data-sources/regional/yufo)
