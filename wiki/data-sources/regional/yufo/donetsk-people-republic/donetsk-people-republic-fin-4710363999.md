---
title: 'Донецкая Народная Республика: УФК по Донецкой Народной Республике'
sidebar_label: УФК по Донецкой Народной Республике
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/donetsk-people-republic-fin-4710363999
...
description: >-
  ...
  учете и распределении поступлений
...
# Донецкая Народная Республика: УФК по Донецкой Народной Республике
...
| Оператор | УФК по Донецкой Народной Республике |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация об обеспечении наличными, учете и распределении поступлений
...
**Комментарий:** Сайт имеет проблемы с сертификатом безопасности, требуется проверка
...
| --- | --- | --- |
| Веб | https://donetsk.roskazna.gov.ru/ | HTML |

## Объекты данных и показатели

- Информация об обеспечении наличными, учете и распределении поступлений
