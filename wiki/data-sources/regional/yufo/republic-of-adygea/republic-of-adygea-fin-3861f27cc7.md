---
title: 'Республика Адыгея: Контрольно-счетная палата Республики Адыгея'
sidebar_label: Контрольно-счетная палата Республики Адыгея
tags:
  - data-source
  - regional
  - control
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/republic-of-adygea-fin-3861f27cc7
...
# Республика Адыгея: Контрольно-счетная палата Республики Адыгея
...
| Оператор | Контрольно-счетная палата Республики Адыгея |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Отчеты о результатах контрольных мероприятий, заключения на проекты бюджетов
...
**Комментарий:** Официальный сайт Контрольно-счетной палаты Республики Адыгея

## Оператор

Контрольно-счетная палата Республики Адыгея — канонический вход: https://kspra.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://kspra.ru/ | HTML |

## Объекты данных и показатели

- Отчеты о результатах контрольных мероприятий, заключения на проекты бюджетов
