---
title: 'Республика Крым: УФК по Республике Крым'
sidebar_label: УФК по Республике Крым
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/republic-of-crimea-fin-fb47a53c53
...
УФК по Республике Крым — канонический вход: https://krym.roskazna.gov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://krym.roskazna.gov.ru/ | HTML |

## Объекты данных и показатели

- Информация об исполнении бюджета, казначейское обслуживание
