---
title: >-
  Запорожская область: Территориальный орган Федеральной службы государственной
  статистики по Запорожской области (Запорожстат)
...
slug: /data-sources/regional/zaporozhye-oblast-fin-223d794082
...
description: >-
  ...
  Росстата): Статистические данные, публикации
...
# Запорожская область: Территориальный орган Федеральной службы государственной статистики по Запорожской области (Запорожстат)
...
| Оператор | Территориальный орган Федеральной службы государственной статистики по Запорожской области (Запорожстат) |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Статистические данные, публикации
...
**Комментарий:** Официальный сайт Запорожстата.

## Оператор

Территориальный орган Федеральной службы государственной статистики по Запорожской области (Запорожстат) — канонический вход: https://85.rosstat.gov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://85.rosstat.gov.ru/ | HTML |

## Объекты данных и показатели

- Статистические данные, публикации
