---
title: 'город Севастополь: Департамент финансов города Севастополя'
sidebar_label: Департамент финансов города Севастополя
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/sevastopol-fin-7c9946b0cc
...
description: >-
  ...
  субъекта): Отчёты об исполнении бюджета, правовые акты, информация о
...
# город Севастополь: Департамент финансов города Севастополя
...
Коротко: Отчёты об исполнении бюджета, правовые акты, информация о деятельности департамента
...
**Комментарий:** Официальный сайт финансового органа города Севастополя

## Оператор

Департамент финансов города Севастополя — канонический вход: https://fin.sev.gov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://fin.sev.gov.ru/ | HTML |

## Объекты данных и показатели

- Отчёты об исполнении бюджета, правовые акты, информация о деятельности департамента
