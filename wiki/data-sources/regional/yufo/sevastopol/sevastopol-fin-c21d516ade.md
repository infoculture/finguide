---
title: 'город Севастополь: Управление Федерального казначейства по г. Севастополю'
sidebar_label: Управление Федерального казначейства по г. Севастопо
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/sevastopol-fin-c21d516ade
...
description: >-
  ...
  управление Федерального казначейства): Информация о деятельности казначейства,
  исполнение бюджета
...
# город Севастополь: Управление Федерального казначейства по г. Севастополю
...
| Оператор | Управление Федерального казначейства по г. Севастополю |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о деятельности казначейства, исполнение бюджета
...
Управление Федерального казначейства по г. Севастополю — канонический вход: https://sevastopol.roskazna.gov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://sevastopol.roskazna.gov.ru/ | HTML |

## Объекты данных и показатели

- Информация о деятельности казначейства, исполнение бюджета
