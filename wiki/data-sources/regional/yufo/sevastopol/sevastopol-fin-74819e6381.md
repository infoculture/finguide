---
title: 'город Севастополь: Контрольно-счетная палата города Севастополя'
sidebar_label: Контрольно-счетная палата города Севастополя
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/sevastopol-fin-74819e6381
source_url: 'http://ksp-sev.ru/'
...
description: >-
  ...
  госфинансам): Отчеты о внешней проверке годового отчета об исполнении бюджета
...
# город Севастополь: Контрольно-счетная палата города Севастополя
...
| Оператор | Контрольно-счетная палата города Севастополя |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Отчеты о внешней проверке годового отчета об исполнении бюджета
...
**Комментарий:** Официальный сайт Контрольно-счетной палаты

## Оператор

Контрольно-счетная палата города Севастополя — канонический вход: http://ksp-sev.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://ksp-sev.ru/ | HTML |

## Объекты данных и показатели

- Отчеты о внешней проверке годового отчета об исполнении бюджета
