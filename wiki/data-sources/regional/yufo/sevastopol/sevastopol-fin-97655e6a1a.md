---
title: 'город Севастополь: Региональный/муниципальный портал открытых данных'
sidebar_label: Региональный/муниципальный портал открытых данных
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/sevastopol-fin-97655e6a1a
...
description: >-
  ...
  госфинансам): Реестр документов и наборов открытых данных об исполнении
  бюджета
...
# город Севастополь: Региональный/муниципальный портал открытых данных
...
| Оператор | Региональный/муниципальный портал открытых данных |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Реестр документов и наборов открытых данных об исполнении бюджета
...
**Комментарий:** Каталог открытых данных, содержащий информацию по бюджету Севастополя

## Оператор

Региональный/муниципальный портал открытых данных — канонический вход: https://datacatalogs.ru/items/rechI6dFcdRVpTNsy

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://datacatalogs.ru/items/rechI6dFcdRVpTNsy | HTML |

## Объекты данных и показатели

- Реестр документов и наборов открытых данных об исполнении бюджета
