---
title: 'город Севастополь: Открытый бюджет города Севастополя'
sidebar_label: Открытый бюджет города Севастополя
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/sevastopol-fin-f5ce94ef86
...
description: >-
  ...
  для граждан): Бюджет для граждан, исполнение доходов и расходов бюджета,
...
# город Севастополь: Открытый бюджет города Севастополя
...
| Оператор | Открытый бюджет города Севастополя |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Бюджет для граждан, исполнение доходов и расходов бюджета, аналитические материалы
...
**Комментарий:** Отдельный портал "Бюджет для граждан"

## Оператор

Открытый бюджет города Севастополя — канонический вход: https://ob.sev.gov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://ob.sev.gov.ru/ | HTML |

## Объекты данных и показатели

- Бюджет для граждан, исполнение доходов и расходов бюджета, аналитические материалы
