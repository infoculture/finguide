---
title: 'Республика Дагестан: Портал «Открытый бюджет» Республики Дагестан'
sidebar_label: Портал «Открытый бюджет» Республики Дагестан
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/republic-of-dagestan-fin-c46fc6e24e
source_url: 'http://portal.minfinrd.ru/'
...
description: >-
  ...
  для граждан): Детализированная информация о региональном бюджете,
...
# Республика Дагестан: Портал «Открытый бюджет» Республики Дагестан
...
| Оператор | Портал «Открытый бюджет» Республики Дагестан |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Детализированная информация о региональном бюджете, интерактивные данные
...
**Комментарий:** Отдельный портал «Открытый бюджет»

## Оператор

Портал «Открытый бюджет» Республики Дагестан — канонический вход: http://portal.minfinrd.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://portal.minfinrd.ru/ | HTML |

## Объекты данных и показатели

- Детализированная информация о региональном бюджете, интерактивные данные
