---
title: 'Ставропольский край: Комитет Ставропольского края по государственным закупкам'
sidebar_label: Комитет Ставропольского края по государственным заку
tags:
  - data-source
  - regional
  - procurement
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/stavropol-krai-fin-edc84779d9
...
description: >-
  ...
  государственных закупках, тендерах
...
# Ставропольский край: Комитет Ставропольского края по государственным закупкам
...
Коротко: Информация о государственных закупках, тендерах
...
**Комментарий:** Официальный портал

## Оператор

Комитет Ставропольского края по государственным закупкам — канонический вход: http://stav-zakupki.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://stav-zakupki.ru/ | HTML |

## Объекты данных и показатели

- Информация о государственных закупках, тендерах
