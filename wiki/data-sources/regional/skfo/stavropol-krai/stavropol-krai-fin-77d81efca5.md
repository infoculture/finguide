---
title: 'Ставропольский край: Ставропольстат'
sidebar_label: Ставропольстат
tags:
  - data-source
  - regional
  - statistics
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/stavropol-krai-fin-77d81efca5
...
description: >-
  ...
  Росстата): Статистические данные по экономике, населению, социальной сфере, в
  том числе финансовые показатели
...
# Ставропольский край: Ставропольстат
...
| Оператор | Ставропольстат |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Статистические данные по экономике, населению, социальной сфере, в том числе финансовые показатели
...
Ставропольстат — канонический вход: https://26.rosstat.gov.ru/ofstatistics_stav

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://26.rosstat.gov.ru/ofstatistics_stav | HTML |

## Объекты данных и показатели

- Статистические данные по экономике, населению, социальной сфере, в том числе финансовые показатели
