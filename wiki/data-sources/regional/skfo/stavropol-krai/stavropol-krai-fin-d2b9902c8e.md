---
title: >-
  Ставропольский край: Министерство финансов Ставропольского края (Внутренний
  государственный финансовый контроль)
sidebar_label: Министерство финансов Ставропольского края (Внутренн
tags:
  - data-source
  - regional
  - control
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/stavropol-krai-fin-d2b9902c8e
...
description: >-
  ...
  контроль): Информация о внутреннем государственном финансовом контроле, планы
...
# Ставропольский край: Министерство финансов Ставропольского края (Внутренний государственный финансовый контроль)
...
| Оператор | Министерство финансов Ставропольского края (Внутренний государственный финансовый контроль) |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о внутреннем государственном финансовом контроле, планы контрольных мероприятий
...
Министерство финансов Ставропольского края (Внутренний государственный финансовый контроль) — канонический вход: https://www.mfsk.ru/working/vnutrenniy-gos.kontrol

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://www.mfsk.ru/working/vnutrenniy-gos.kontrol | HTML |

## Объекты данных и показатели

- Информация о внутреннем государственном финансовом контроле, планы контрольных мероприятий
