---
title: 'Ставропольский край: Контрольно-счетная палата Ставропольского края'
sidebar_label: Контрольно-счетная палата Ставропольского края
tags:
  - data-source
  - regional
  - control
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/stavropol-krai-fin-7a50977f54
source_url: 'http://www.kspstav.ru/'
...
description: >-
  ...
  орган): Отчеты о проверках использования бюджетных средств, результаты
...
# Ставропольский край: Контрольно-счетная палата Ставропольского края
...
| Оператор | Контрольно-счетная палата Ставропольского края |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Отчеты о проверках использования бюджетных средств, результаты финансового контроля
...
Контрольно-счетная палата Ставропольского края — канонический вход: http://www.kspstav.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://www.kspstav.ru/ | HTML |

## Объекты данных и показатели

- Отчеты о проверках использования бюджетных средств, результаты финансового контроля
