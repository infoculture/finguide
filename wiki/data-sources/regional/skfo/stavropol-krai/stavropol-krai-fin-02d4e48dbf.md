---
title: 'Ставропольский край: Открытый бюджет Ставропольского края'
sidebar_label: Открытый бюджет Ставропольского края
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/stavropol-krai-fin-02d4e48dbf
...
description: >-
  ...
  для граждан): Информация о бюджете края, бюджет для граждан
...
# Ставропольский край: Открытый бюджет Ставропольского края
...
Открытый бюджет Ставропольского края — канонический вход: https://openbudsk.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://openbudsk.ru/ | HTML |

## Объекты данных и показатели

- Информация о бюджете края, бюджет для граждан
