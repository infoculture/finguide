---
title: 'Алтайский край: Открытые данные Министерства финансов Алтайского края'
sidebar_label: Открытые данные Министерства финансов Алтайского кра
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/altai-krai-fin-b020ccc720
...
description: >-
  ...
  для граждан): Открытые данные, информация о бюджете для граждан
...
# Алтайский край: Открытые данные Министерства финансов Алтайского края
...
| Оператор | Открытые данные Министерства финансов Алтайского края |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Открытые данные, информация о бюджете для граждан
...
Открытые данные Министерства финансов Алтайского края — канонический вход: https://minfin.alregn.ru/opendata

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://minfin.alregn.ru/opendata | HTML |

## Объекты данных и показатели

- Открытые данные, информация о бюджете для граждан
