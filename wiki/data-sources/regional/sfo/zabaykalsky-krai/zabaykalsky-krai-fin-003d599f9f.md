---
title: 'Забайкальский край: Официальный портал Забайкальского края'
sidebar_label: Официальный портал Забайкальского края
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/zabaykalsky-krai-fin-003d599f9f
source_url: 'https://75.ru/'
...
description: >-
  ...
  бюджетные разделы): Общая информация о деятельности правительства, новости
...
# Забайкальский край: Официальный портал Забайкальского края
...
| Оператор | Официальный портал Забайкальского края |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Общая информация о деятельности правительства, новости
...
**Комментарий:** Общий портал правительства края, может содержать ссылки на финансовые документы.

## Оператор

Официальный портал Забайкальского края — канонический вход: https://75.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://75.ru/ | HTML |

## Объекты данных и показатели

- Общая информация о деятельности правительства, новости
