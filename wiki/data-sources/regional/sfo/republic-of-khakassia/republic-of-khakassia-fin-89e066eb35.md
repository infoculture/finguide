---
title: >-
  Республика Хакасия: Портал открытых данных Верховного Совета Республики
  Хакасия
sidebar_label: 'Портал открытых данных Верховного Совета Республики '
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/republic-of-khakassia-fin-89e066eb35
...
description: >-
  ...
  госфинансам): Опубликованные наборы открытых данных
...
# Республика Хакасия: Портал открытых данных Верховного Совета Республики Хакасия
...
| Оператор | Портал открытых данных Верховного Совета Республики Хакасия |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Опубликованные наборы открытых данных
...
Портал открытых данных Верховного Совета Республики Хакасия — канонический вход: https://vs19.ru/citizens/otkrytye-dannye

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://vs19.ru/citizens/otkrytye-dannye | HTML |

## Объекты данных и показатели

- Опубликованные наборы открытых данных
