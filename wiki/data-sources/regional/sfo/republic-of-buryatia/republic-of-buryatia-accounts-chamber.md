---
title: 'Республика Бурятия: Счетная палата Республики Бурятия'
sidebar_label: Счетная палата Республики Бурятия
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/republic-of-buryatia-fin-2010ecbbad
source_url: 'https://sp03.ru/'
...
description: >-
  ...
  госфинансам): Результаты контрольных мероприятий, отчеты
...
# Республика Бурятия: Счетная палата Республики Бурятия
...
**Комментарий:** Официальный сайт Счетной палаты.

## Оператор

Счетная палата Республики Бурятия — канонический вход: https://sp03.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://sp03.ru/ | HTML |

## Объекты данных и показатели

- Результаты контрольных мероприятий, отчеты
