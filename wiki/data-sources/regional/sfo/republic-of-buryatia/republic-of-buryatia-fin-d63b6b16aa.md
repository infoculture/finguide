---
title: 'Республика Бурятия: Открытый бюджет Республики Бурятия'
sidebar_label: Открытый бюджет Республики Бурятия
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/republic-of-buryatia-fin-d63b6b16aa
source_url: 'https://open.budget.govrb.ru/'
...
description: >-
  ...
  для граждан): Реестр документов закона о бюджете и его исполнении
...
# Республика Бурятия: Открытый бюджет Республики Бурятия
...
| Оператор | Открытый бюджет Республики Бурятия |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Реестр документов закона о бюджете и его исполнении
...
**Категория (таблица):** Официальный сайт регионального проекта «Открытый бюджет», «Бюджет для граждан»

**Статус исследования:** найдено

**Комментарий:** Портал "Открытый бюджет Республики Бурятия".

## Оператор

Открытый бюджет Республики Бурятия — канонический вход: https://open.budget.govrb.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://open.budget.govrb.ru/ | HTML |

## Объекты данных и показатели

- Реестр документов закона о бюджете и его исполнении
