---
title: 'Новосибирская область: Открытый бюджет Новосибирской области'
sidebar_label: Открытый бюджет Новосибирской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/novosibirsk-oblast-fin-ff32d02839
source_url: 'https://openbudget.mfnso.nso.ru/'
...
description: >-
  ...
  для граждан): Бюджет для граждан, аналитика, государственные программы
...
# Новосибирская область: Открытый бюджет Новосибирской области
...
| Оператор | Открытый бюджет Новосибирской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Бюджет для граждан, аналитика, государственные программы
...
**Комментарий:** Портал для раскрытия информации о бюджете в доступной форме.

## Оператор

Открытый бюджет Новосибирской области — канонический вход: https://openbudget.mfnso.nso.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://openbudget.mfnso.nso.ru/ | HTML |

## Объекты данных и показатели

- Бюджет для граждан, аналитика, государственные программы
