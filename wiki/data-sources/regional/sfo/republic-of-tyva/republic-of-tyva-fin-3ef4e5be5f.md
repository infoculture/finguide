---
title: 'Республика Тыва: Контрольно-счетная палата города Кызыла'
sidebar_label: Контрольно-счетная палата города Кызыла
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/republic-of-tyva-fin-3ef4e5be5f
source_url: 'https://ksp-kzl.ru/'
...
description: >-
  ...
  Отчеты о деятельности, информация о муниципальном финансовом контроле
...
# Республика Тыва: Контрольно-счетная палата города Кызыла
...
| Оператор | Контрольно-счетная палата города Кызыла |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Отчеты о деятельности, информация о муниципальном финансовом контроле
...
**Комментарий:** Официальный сайт КСП города Кызыла

## Оператор

Контрольно-счетная палата города Кызыла — канонический вход: https://ksp-kzl.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://ksp-kzl.ru/ | HTML |
