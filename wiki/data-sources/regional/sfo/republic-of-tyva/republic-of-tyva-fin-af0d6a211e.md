---
title: >-
  Республика Тыва: Официальный интернет-портал правовой информации (Республика
  Тыва)
...
slug: /data-sources/regional/republic-of-tyva-fin-af0d6a211e
source_url: 'http://publication.pravo.gov.ru/documents/block/region17'
...
description: >-
  ...
  база): Официальное опубликование правовых актов Республики Тыва
...
# Республика Тыва: Официальный интернет-портал правовой информации (Республика Тыва)
...
| Оператор | Официальный интернет-портал правовой информации (Республика Тыва) |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Официальное опубликование правовых актов Республики Тыва
...
Официальный интернет-портал правовой информации (Республика Тыва) — канонический вход: http://publication.pravo.gov.ru/documents/block/region17

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://publication.pravo.gov.ru/documents/block/region17 | HTML |

## Объекты данных и показатели

- Официальное опубликование правовых актов Республики Тыва
