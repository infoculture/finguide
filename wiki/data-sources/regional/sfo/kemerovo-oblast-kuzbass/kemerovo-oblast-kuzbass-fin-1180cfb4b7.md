---
title: >-
  Кемеровская область — Кузбасс: Единая информационная система в сфере закупок
  (Департамент контрактной системы Кузбасса)
sidebar_label: Единая информационная система в сфере закупок (Депар
tags:
  - data-source
  - regional
  - procurement
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/kemerovo-oblast-kuzbass-fin-1180cfb4b7
source_url: >-
  https://zakupki.gov.ru/epz/organization/view/info.html?organizationCode=01392000001
...
# Кемеровская область — Кузбасс: Единая информационная система в сфере закупок (Департамент контрактной системы Кузбасса)
...
| Оператор | Единая информационная система в сфере закупок (Департамент контрактной системы Кузбасса) |
...
**Комментарий:** Страница Департамента контрактной системы Кузбасса на федеральном портале госзакупок

## Оператор

Единая информационная система в сфере закупок (Департамент контрактной системы Кузбасса) — канонический вход: https://zakupki.gov.ru/epz/organization/view/info.html?organizationCode=01392000001

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://zakupki.gov.ru/epz/organization/view/info.html?organizationCode=01392000001 | HTML |
