---
title: >-
  Кемеровская область — Кузбасс: Администрация Правительства Кузбасса. Бюджет
  для граждан
sidebar_label: Администрация Правительства Кузбасса. Бюджет для гра
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/kemerovo-oblast-kuzbass-fin-ee270f4108
source_url: 'https://www.ako.ru/documents/byudzhet-dlya-grazhdan.php'
...
description: >-
  ...
  бюджетные разделы): Упрощенная версия бюджетного документа
...
# Кемеровская область — Кузбасс: Администрация Правительства Кузбасса. Бюджет для граждан
...
| Оператор | Администрация Правительства Кузбасса. Бюджет для граждан |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Упрощенная версия бюджетного документа
...
**Комментарий:** Раздел "Бюджет для граждан" на портале Правительства Кузбасса

## Оператор

Администрация Правительства Кузбасса. Бюджет для граждан — канонический вход: https://www.ako.ru/documents/byudzhet-dlya-grazhdan.php

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://www.ako.ru/documents/byudzhet-dlya-grazhdan.php | HTML |

## Объекты данных и показатели

- Упрощенная версия бюджетного документа
