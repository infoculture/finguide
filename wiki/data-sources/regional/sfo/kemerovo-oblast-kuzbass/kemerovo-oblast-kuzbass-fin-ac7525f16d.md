---
title: >-
  Кемеровская область — Кузбасс: Министерство финансов Кузбасса. Финансовый
  контроль
sidebar_label: Министерство финансов Кузбасса. Финансовый контроль
tags:
  - data-source
  - regional
  - control
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/kemerovo-oblast-kuzbass-fin-ac7525f16d
source_url: 'https://www.ofukem.ru/about/finance-control'
...
description: >-
  ...
  контроль): Информация о внутреннем финансовом контроле
...
# Кемеровская область — Кузбасс: Министерство финансов Кузбасса. Финансовый контроль
...
| Оператор | Министерство финансов Кузбасса. Финансовый контроль |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о внутреннем финансовом контроле
...
**Комментарий:** Раздел финансового контроля на сайте Минфина Кузбасса

## Оператор

Министерство финансов Кузбасса. Финансовый контроль — канонический вход: https://www.ofukem.ru/about/finance-control

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://www.ofukem.ru/about/finance-control | HTML |

## Объекты данных и показатели

- Информация о внутреннем финансовом контроле
