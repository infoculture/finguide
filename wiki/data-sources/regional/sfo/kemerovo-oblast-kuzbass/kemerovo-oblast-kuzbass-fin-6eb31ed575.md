---
title: >-
  Кемеровская область — Кузбасс: Министерство финансов Кузбасса. Бюджет для
  граждан
sidebar_label: Министерство финансов Кузбасса. Бюджет для граждан
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/kemerovo-oblast-kuzbass-fin-6eb31ed575
source_url: 'https://www.ofukem.ru/activity/budget-citizens'
...
description: >-
  ...
  для граждан): Информация о бюджете в доступной форме для граждан
...
# Кемеровская область — Кузбасс: Министерство финансов Кузбасса. Бюджет для граждан
...
| Оператор | Министерство финансов Кузбасса. Бюджет для граждан |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о бюджете в доступной форме для граждан
...
**Комментарий:** Раздел 'Бюджет для граждан' на сайте Минфина Кузбасса

## Оператор

Министерство финансов Кузбасса. Бюджет для граждан — канонический вход: https://www.ofukem.ru/activity/budget-citizens

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://www.ofukem.ru/activity/budget-citizens | HTML |

## Объекты данных и показатели

- Информация о бюджете в доступной форме для граждан
