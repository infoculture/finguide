---
title: 'Кемеровская область — Кузбасс: Контрольно-счетная палата города Кемерово'
sidebar_label: Контрольно-счетная палата города Кемерово
tags:
  - data-source
  - regional
  - control
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/kemerovo-oblast-kuzbass-fin-6d6a3fe87d
source_url: 'https://kemksp.ru/'
...
description: >-
  ...
  орган): Отчеты о результатах контрольных мероприятий в городе Кемерово
...
# Кемеровская область — Кузбасс: Контрольно-счетная палата города Кемерово
...
| Оператор | Контрольно-счетная палата города Кемерово |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Отчеты о результатах контрольных мероприятий в городе Кемерово
...
**Комментарий:** Официальный сайт муниципальной КСП

## Оператор

Контрольно-счетная палата города Кемерово — канонический вход: https://kemksp.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://kemksp.ru/ | HTML |

## Объекты данных и показатели

- Отчеты о результатах контрольных мероприятий в городе Кемерово
