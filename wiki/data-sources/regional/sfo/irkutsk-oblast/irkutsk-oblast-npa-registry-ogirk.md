---
title: 'Иркутская область: Правовой портал Иркутской области'
sidebar_label: Правовой портал Иркутской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/irkutsk-oblast-fin-25edd7ad24
source_url: 'https://www.ogirk.ru/pravo/reestr'
...
description: >-
  ...
  база): Реестр правовых актов, включая законы, касающиеся бюджета и финансов
...
# Иркутская область: Правовой портал Иркутской области
...
| Оператор | Правовой портал Иркутской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Реестр правовых актов, включая законы, касающиеся бюджета и финансов
...
Правовой портал Иркутской области — канонический вход: https://www.ogirk.ru/pravo/reestr

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://www.ogirk.ru/pravo/reestr | HTML |

## Объекты данных и показатели

- Реестр правовых актов, включая законы, касающиеся бюджета и финансов
