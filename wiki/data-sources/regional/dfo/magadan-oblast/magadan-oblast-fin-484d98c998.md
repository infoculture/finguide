---
title: 'Магаданская область: Единая информационная система в сфере закупок'
...
slug: /data-sources/regional/magadan-oblast-fin-484d98c998
source_url: 'http://zakupki.gov.ru/'
...
# Магаданская область: Единая информационная система в сфере закупок
...
**Комментарий:** Федеральный портал, содержащий данные по закупкам Магаданской области.

## Оператор

Единая информационная система в сфере закупок — канонический вход: http://zakupki.gov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://zakupki.gov.ru/ | HTML |
