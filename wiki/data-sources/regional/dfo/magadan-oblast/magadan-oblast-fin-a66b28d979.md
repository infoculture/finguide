---
title: 'Магаданская область: Официальный интернет-портал правовой информации'
...
slug: /data-sources/regional/magadan-oblast-fin-a66b28d979
source_url: 'http://pravo.gov.ru/links/magadan_obl'
...
description: >-
  ...
  база): Нормативные правовые акты Магаданской области
...
# Магаданская область: Официальный интернет-портал правовой информации
...
Коротко: Нормативные правовые акты Магаданской области
...
**Комментарий:** Портал содержит ссылки на правовые акты, но прямого доступа к базе документов не было.

## Оператор

Официальный интернет-портал правовой информации — канонический вход: http://pravo.gov.ru/links/magadan_obl

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://pravo.gov.ru/links/magadan_obl | HTML |

## Объекты данных и показатели

- Нормативные правовые акты Магаданской области
