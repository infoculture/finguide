---
title: 'Магаданская область: Открытый бюджет Магаданской области'
sidebar_label: Открытый бюджет Магаданской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/magadan-oblast-fin-5a8ccc9aa8
...
description: >-
  ...
  для граждан): Параметры областного бюджета, исполнение бюджета,
  государственный и муниципальный долг, анализ налоговой отчетности, сводная
  информация об и
...
# Магаданская область: Открытый бюджет Магаданской области
...
| Оператор | Открытый бюджет Магаданской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Параметры областного бюджета, исполнение бюджета, государственный и муниципальный долг, анализ налоговой отчетности, сводная информация об исполнении местных бюджетов
...
**Комментарий:** Отдельный портал с подробными бюджетными данными, включая муниципальные.

## Оператор

Открытый бюджет Магаданской области — канонический вход: https://openbudget.49gov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://openbudget.49gov.ru/ | HTML |

## Объекты данных и показатели

- Параметры областного бюджета, исполнение бюджета, государственный и муниципальный долг, анализ налоговой отчетности, сводная информация об исполнении местных бюджетов
