---
title: 'Еврейская автономная область: Единая информационная система в сфере закупок'
...
slug: /data-sources/regional/jewish-autonomous-oblast-fin-a1cdd49560
...
# Еврейская автономная область: Единая информационная система в сфере закупок
...
| Оператор | Единая информационная система в сфере закупок |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о государственных и муниципальных закупках
...
Единая информационная система в сфере закупок — канонический вход: https://zakupki.gov.ru/epz/order/extendedsearch/results.html

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://zakupki.gov.ru/epz/order/extendedsearch/results.html | HTML |
