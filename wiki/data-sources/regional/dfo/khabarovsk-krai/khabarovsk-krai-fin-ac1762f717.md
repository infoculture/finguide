---
title: 'Хабаровский край: Контрольно-счетная палата Хабаровского края'
sidebar_label: Контрольно-счетная палата Хабаровского края
tags:
  - data-source
  - regional
  - control
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/khabarovsk-krai-fin-ac1762f717
source_url: 'http://ksp27.ru/'
...
description: >-
  ...
  орган): Результаты аудита и контроля за использованием бюджетных средств
...
# Хабаровский край: Контрольно-счетная палата Хабаровского края
...
| Оператор | Контрольно-счетная палата Хабаровского края |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Результаты аудита и контроля за использованием бюджетных средств
...
**Комментарий:** Осуществляет внешний финансовый контроль.

## Оператор

Контрольно-счетная палата Хабаровского края — канонический вход: http://ksp27.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://ksp27.ru/ | HTML |

## Объекты данных и показатели

- Результаты аудита и контроля за использованием бюджетных средств
