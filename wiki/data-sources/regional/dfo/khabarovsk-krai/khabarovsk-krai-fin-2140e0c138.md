...
sidebar_label: Управление Федерального казначейства по Хабаровскому
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/khabarovsk-krai-fin-2140e0c138
...
description: >-
  ...
  нормативные документы, открытие и ведение лицевых счетов
...
Коротко: Учет и распределение поступлений, нормативные документы, открытие и ведение лицевых счетов
...
**Комментарий:** Основной сайт территориального управления Федерального казначейства.
...
| --- | --- | --- |
| Веб | https://khabarovsk.roskazna.gov.ru/ | HTML |

## Объекты данных и показатели

- Учет и распределение поступлений, нормативные документы, открытие и ведение лицевых счетов
...
- [Сводная страница субъекта](/data-sources/regional/subject-khabarovsk-krai-sources-overview) — все источники по этому субъекту в wiki.
