---
title: 'Амурская область: Портал открытых данных Российской Федерации'
sidebar_label: Портал открытых данных Российской Федерации
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/amur-oblast-fin-dc60bf10f0
...
description: >-
  ...
  региональным разрезом): Открытые данные, включая региональный разрез.
...
# Амурская область: Портал открытых данных Российской Федерации
...
| Оператор | Портал открытых данных Российской Федерации |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Открытые данные, включая региональный разрез.
...
**Комментарий:** Федеральный портал открытых данных.

## Оператор

Портал открытых данных Российской Федерации — канонический вход: https://data.gov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://data.gov.ru/ | HTML |

## Объекты данных и показатели

- Открытые данные, включая региональный разрез.
