---
title: 'Амурская область: Открытый бюджет Амурской области'
sidebar_label: Открытый бюджет Амурской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/amur-oblast-fin-3c7e5221ef
...
description: >-
  ...
  для граждан): Информация о доходах и расходах бюджета, госпрограммы, аналитика
...
# Амурская область: Открытый бюджет Амурской области
...
| Оператор | Открытый бюджет Амурской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о доходах и расходах бюджета, госпрограммы, аналитика
...
**Комментарий:** Прямой доступ к сайту затруднен, но существование подтверждено.

## Оператор

Открытый бюджет Амурской области — канонический вход: https://ob.amurobl.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://ob.amurobl.ru/ | HTML |

## Объекты данных и показатели

- Информация о доходах и расходах бюджета, госпрограммы, аналитика
