...
sidebar_label: Управление контроля в сфере закупок и финансов…
tags:
  - data-source
  - regional
  - control
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/amur-oblast-fin-32f2a32b78
source_url: >-
...
description: >-
  ...
  контроль): Информация о контроле в сфере закупок и финансов.
...
| Оператор | Управление контроля в сфере закупок и финансов (Правительство Амурской области) |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о контроле в сфере закупок и финансов.
...
**Комментарий:** Вероятно, выполняет функции внутреннего финансового контроля.

## Оператор

Управление контроля в сфере закупок и финансов (Правительство Амурской области) — канонический вход: https://xn--80abedla9acxg1b7f.xn--p1ai/contacts/upravlenie-kontrolya-v-sfere-zakupok-i-finansov

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://xn--80abedla9acxg1b7f.xn--p1ai/contacts/upravlenie-kontrolya-v-sfere-zakupok-i-finansov | HTML |

## Объекты данных и показатели

- Информация о контроле в сфере закупок и финансов.
