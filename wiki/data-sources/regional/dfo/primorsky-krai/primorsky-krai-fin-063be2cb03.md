---
title: 'Приморский край: Открытый бюджет Приморского края'
sidebar_label: Открытый бюджет Приморского края
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/primorsky-krai-fin-063be2cb03
...
description: >-
  ...
  для граждан): Бюджетные данные в доступной форме для граждан
...
# Приморский край: Открытый бюджет Приморского края
...
Открытый бюджет Приморского края — канонический вход: https://ebudget.primorsky.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://ebudget.primorsky.ru/ | HTML |

## Объекты данных и показатели

- Бюджетные данные в доступной форме для граждан
