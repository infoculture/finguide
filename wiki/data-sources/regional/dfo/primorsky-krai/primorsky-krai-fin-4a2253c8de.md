---
title: 'Приморский край: Портал открытых данных Приморского края'
...
slug: /data-sources/regional/primorsky-krai-fin-4a2253c8de
...
description: >-
  ...
  госфинансам): Открытые данные, включая геопространственные
...
# Приморский край: Портал открытых данных Приморского края
...
Портал открытых данных Приморского края — канонический вход: https://opendata.primorsky.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://opendata.primorsky.ru/ | HTML |

## Объекты данных и показатели

- Открытые данные, включая геопространственные
