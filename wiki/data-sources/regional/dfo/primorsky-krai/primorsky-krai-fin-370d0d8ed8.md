---
title: 'Приморский край: Министерство финансов Приморского края'
sidebar_label: Министерство финансов Приморского края
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/primorsky-krai-fin-370d0d8ed8
source_url: 'https://primorsky.ru/authorities/executive-agencies/departments/finance'
...
description: >-
  ...
  субъекта): Информация о финансовой политике, бюджете края
...
# Приморский край: Министерство финансов Приморского края
...
**Комментарий:** Сайт часто недоступен, требуется дополнительная проверка

## Оператор

Министерство финансов Приморского края — канонический вход: https://primorsky.ru/authorities/executive-agencies/departments/finance

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://primorsky.ru/authorities/executive-agencies/departments/finance | HTML |

## Объекты данных и показатели

- Информация о финансовой политике, бюджете края
...
- [Сводная страница субъекта](/data-sources/regional/subject-primorsky-krai-sources-overview) — все источники по этому субъекту в wiki.
