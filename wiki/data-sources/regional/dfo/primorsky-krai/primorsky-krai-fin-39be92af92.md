...
slug: /data-sources/regional/primorsky-krai-fin-39be92af92
source_url: 'https://www.datacatalogs.ru/items/recf6kBmsQjYayNgt'
...
description: >-
  ...
  госфинансам): Наборы данных, в том числе геопространственных
...
# Приморский край: Портал открытых данных Приморского края (Datacatalogs.ru)
...
| Оператор | Портал открытых данных Приморского края (Datacatalogs.ru) |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Наборы данных, в том числе геопространственных
...
Портал открытых данных Приморского края (Datacatalogs.ru) — канонический вход: https://www.datacatalogs.ru/items/recf6kBmsQjYayNgt

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://www.datacatalogs.ru/items/recf6kBmsQjYayNgt | HTML |

## Объекты данных и показатели

- Наборы данных, в том числе геопространственных
