...
title: >-
  ...
  Чукотского автономного округа (раздел "Внутриведомственный контроль")
...
slug: /data-sources/regional/chukotka-autonomous-okrug-fin-83fca39f24
...
description: >-
  ...
  контроль): Результаты внутриведомственного контроля
...
# Чукотский автономный округ: Департамент финансов и имущественных отношений Чукотского автономного округа (раздел "Внутриведомственный контроль")
...
| Оператор | Департамент финансов и имущественных отношений Чукотского автономного округа (раздел "Внутриведомственный контроль") |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Результаты внутриведомственного контроля
...
**Комментарий:** Раздел о внутриведомственном контроле на сайте Департамента финансов

## Оператор

Департамент финансов и имущественных отношений Чукотского автономного округа (раздел "Внутриведомственный контроль") — канонический вход: https://xn--80atapud1a.xn--p1ai/depfin/activity/vnutrive-kontrol

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://xn--80atapud1a.xn--p1ai/depfin/activity/vnutrive-kontrol | HTML |

## Объекты данных и показатели

- Результаты внутриведомственного контроля
