---
title: 'Республика Башкортостан: Открытый бюджет города Уфы'
sidebar_label: Открытый бюджет города Уфы
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/republic-of-bashkortostan-fin-a17e8cedf6
source_url: 'https://finance.ufacity.info/'
...
description: >-
  ...
  для граждан): Бюджетные данные города Уфы
...
# Республика Башкортостан: Открытый бюджет города Уфы
...
**Комментарий:** Содержит муниципальные финансовые данные.

## Оператор

Открытый бюджет города Уфы — канонический вход: https://finance.ufacity.info/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://finance.ufacity.info/ | HTML |

## Объекты данных и показатели

- Бюджетные данные города Уфы
