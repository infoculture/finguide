---
title: >-
  Республика Башкортостан: Аналитический портал Министерства финансов Республики
  Башкортостан
sidebar_label: Аналитический портал Министерства финансов Республик
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/republic-of-bashkortostan-fin-d13b79623f
source_url: 'https://budget.bashkortostan.ru/'
...
description: >-
  ...
  госфинансам): Анализ основных параметров республиканского бюджета, мониторинг
  исполнения
...
# Республика Башкортостан: Аналитический портал Министерства финансов Республики Башкортостан
...
| Оператор | Аналитический портал Министерства финансов Республики Башкортостан |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Анализ основных параметров республиканского бюджета, мониторинг исполнения
...
**Комментарий:** Портал испытывал проблемы с доступом, но идентифицирован как источник аналитических данных.

## Оператор

Аналитический портал Министерства финансов Республики Башкортостан — канонический вход: https://budget.bashkortostan.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://budget.bashkortostan.ru/ | HTML |

## Объекты данных и показатели

- Анализ основных параметров республиканского бюджета, мониторинг исполнения
