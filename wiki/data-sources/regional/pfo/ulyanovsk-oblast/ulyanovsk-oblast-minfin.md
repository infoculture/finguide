---
title: 'Ульяновская область: Министерство финансов Ульяновской области'
sidebar_label: Министерство финансов Ульяновской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/ulyanovsk-oblast-fin-a666b9f9b2
source_url: 'https://ulminfin.ru/'
...
description: >-
  ...
  субъекта): Бюджетная информация, исполнение бюджета, открытый бюджет
...
# Ульяновская область: Министерство финансов Ульяновской области
...
| Оператор | Министерство финансов Ульяновской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Бюджетная информация, исполнение бюджета, открытый бюджет
...
**Комментарий:** Главный финансовый орган региона

## Оператор

Министерство финансов Ульяновской области — канонический вход: https://ulminfin.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://ulminfin.ru/ | HTML |

## Объекты данных и показатели

- Бюджетная информация, исполнение бюджета, открытый бюджет
