---
title: 'Ульяновская область: Счетная палата Ульяновской области'
sidebar_label: Счетная палата Ульяновской области
tags:
  - data-source
  - regional
  - control
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/ulyanovsk-oblast-fin-60e6c69b7a
source_url: 'https://spuo.ru/'
...
description: >-
  ...
  орган): Отчеты о контрольных мероприятиях, планы работы, стандарты финансового
  контроля
...
# Ульяновская область: Счетная палата Ульяновской области
...
| Оператор | Счетная палата Ульяновской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Отчеты о контрольных мероприятиях, планы работы, стандарты финансового контроля
...
Счетная палата Ульяновской области — канонический вход: https://spuo.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://spuo.ru/ | HTML |

## Объекты данных и показатели

- Отчеты о контрольных мероприятиях, планы работы, стандарты финансового контроля
