---
title: 'Чувашская Республика: Единый портал бюджетной системы Чувашской Республики'
sidebar_label: Единый портал бюджетной системы Чувашской Республики
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/chuvash-republic-fin-f1aab5e946
source_url: 'https://budget.cap.ru/'
...
description: >-
  ...
  для граждан): Оперативная информация об исполнении консолидированных бюджетов
...
# Чувашская Республика: Единый портал бюджетной системы Чувашской Республики
...
| Оператор | Единый портал бюджетной системы Чувашской Республики |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Оперативная информация об исполнении консолидированных бюджетов муниципальных районов и городских округов
...
**Комментарий:** Сайт недоступен, но упоминается в других источниках

## Оператор

Единый портал бюджетной системы Чувашской Республики — канонический вход: https://budget.cap.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://budget.cap.ru/ | HTML |

## Объекты данных и показатели

- Оперативная информация об исполнении консолидированных бюджетов муниципальных районов и городских округов
