---
title: >-
  Пензенская область: Территориальный фонд обязательного медицинского
...
slug: /data-sources/regional/penza-oblast-fin-0c40b5f1fd
source_url: 'http://www.omspenza.ru/%60'
...
description: >-
  ...
  ОМС): Нормативные документы по ОМС, информация для страхователей и
  застрахованных
...
# Пензенская область: Территориальный фонд обязательного медицинского страхования Пензенской области
...
Коротко: Нормативные документы по ОМС, информация для страхователей и застрахованных
...
Территориальный фонд обязательного медицинского страхования Пензенской области — канонический вход: http://www.omspenza.ru/%60

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://www.omspenza.ru/%60 | HTML |

## Объекты данных и показатели

- Нормативные документы по ОМС, информация для страхователей и застрахованных
