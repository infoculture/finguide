---
title: 'Пензенская область: Открытый Бюджет Пензенской области (на сайте Минфина)'
sidebar_label: Открытый Бюджет Пензенской области (на сайте Минфина
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/penza-oblast-fin-dfa6edfc8f
source_url: 'https://finance.pnzreg.ru/docs/bpo/otkrbudpo/%60'
...
description: >-
  ...
  для граждан): Бюджет Пензенской области для граждан
...
# Пензенская область: Открытый Бюджет Пензенской области (на сайте Минфина)
...
| Оператор | Открытый Бюджет Пензенской области (на сайте Минфина) |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Бюджет Пензенской области для граждан
...
Открытый Бюджет Пензенской области (на сайте Минфина) — канонический вход: https://finance.pnzreg.ru/docs/bpo/otkrbudpo/%60

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://finance.pnzreg.ru/docs/bpo/otkrbudpo/%60 | HTML |

## Объекты данных и показатели

- Бюджет Пензенской области для граждан
