---
title: >-
  Пензенская область: Официальный интернет-портал правовой информации (раздел
  Пензенской области)
...
slug: /data-sources/regional/penza-oblast-fin-b9b9816d9a
source_url: 'http://publication.pravo.gov.ru/documents/block/region58%60'
...
description: >-
  ...
  база): Нормативные правовые акты, включая финансовые
...
# Пензенская область: Официальный интернет-портал правовой информации (раздел Пензенской области)
...
| Оператор | Официальный интернет-портал правовой информации (раздел Пензенской области) |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Нормативные правовые акты, включая финансовые
...
Официальный интернет-портал правовой информации (раздел Пензенской области) — канонический вход: http://publication.pravo.gov.ru/documents/block/region58%60

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://publication.pravo.gov.ru/documents/block/region58%60 | HTML |

## Объекты данных и показатели

- Нормативные правовые акты, включая финансовые
