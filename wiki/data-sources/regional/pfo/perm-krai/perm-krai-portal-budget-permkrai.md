---
title: 'Пермский край: Понятный бюджет Пермского края'
sidebar_label: Понятный бюджет Пермского края
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/perm-krai-fin-9fc0d302df
source_url: 'https://budget.permkrai.ru/'
...
description: >-
  ...
  для граждан): Информация о бюджете Пермского края в доступной форме,
  исполнение бюджета, проекты
...
# Пермский край: Понятный бюджет Пермского края
...
| Оператор | Понятный бюджет Пермского края |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о бюджете Пермского края в доступной форме, исполнение бюджета, проекты
...
Понятный бюджет Пермского края — канонический вход: https://budget.permkrai.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://budget.permkrai.ru/ | HTML |

## Объекты данных и показатели

- Информация о бюджете Пермского края в доступной форме, исполнение бюджета, проекты
