---
title: 'Пермский край: Публичный бюджет города Перми'
sidebar_label: Публичный бюджет города Перми
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/perm-krai-fin-6407e4f71e
source_url: 'https://budget.gorodperm.ru/'
...
description: >-
  ...
  госфинансам): Бюджет города Перми, исполнение бюджета, бюджет для граждан
...
# Пермский край: Публичный бюджет города Перми
...
| Оператор | Публичный бюджет города Перми |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Бюджет города Перми, исполнение бюджета, бюджет для граждан
...
Публичный бюджет города Перми — канонический вход: https://budget.gorodperm.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://budget.gorodperm.ru/ | HTML |

## Объекты данных и показатели

- Бюджет города Перми, исполнение бюджета, бюджет для граждан
