---
title: 'Республика Мордовия: Мордовиястат'
sidebar_label: Мордовиястат
tags:
  - data-source
  - regional
  - statistics
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/republic-of-mordovia-fin-62d18a6e53
source_url: 'https://13.rosstat.gov.ru/'
...
description: >-
  ...
  Росстата): Статистические данные по Республике Мордовия, включая экономические
  показатели, индексы цен, заработную плату
...
# Республика Мордовия: Мордовиястат
...
| Оператор | Мордовиястат |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Статистические данные по Республике Мордовия, включая экономические показатели, индексы цен, заработную плату
...
**Комментарий:** Предоставляет официальную статистическую информацию по региону.

## Оператор

Мордовиястат — канонический вход: https://13.rosstat.gov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://13.rosstat.gov.ru/ | HTML |

## Объекты данных и показатели

- Статистические данные по Республике Мордовия, включая экономические показатели, индексы цен, заработную плату
