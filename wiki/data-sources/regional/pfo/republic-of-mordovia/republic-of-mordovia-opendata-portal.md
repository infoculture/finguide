---
title: 'Республика Мордовия: Портал открытых данных Республики Мордовия'
sidebar_label: Портал открытых данных Республики Мордовия
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/republic-of-mordovia-fin-19981668a9
source_url: 'https://data.e-mordovia.ru/'
...
description: >-
  ...
  открытых данных, включая финансовые и бюджетные показатели
...
# Республика Мордовия: Портал открытых данных Республики Мордовия
...
| Оператор | Портал открытых данных Республики Мордовия |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Наборы открытых данных, включая финансовые и бюджетные показатели
...
**Категория (таблица):** Региональный портал открытых данных

**Статус исследования:** найдено

**Комментарий:** Предоставляет доступ к различным наборам открытых данных Республики Мордовия.

## Оператор

Портал открытых данных Республики Мордовия — канонический вход: https://data.e-mordovia.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://data.e-mordovia.ru/ | HTML |

## Объекты данных и показатели

- Наборы открытых данных, включая финансовые и бюджетные показатели
