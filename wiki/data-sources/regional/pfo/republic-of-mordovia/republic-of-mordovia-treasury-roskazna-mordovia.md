---
title: 'Республика Мордовия: УФК по Республике Мордовия'
sidebar_label: УФК по Республике Мордовия
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/republic-of-mordovia-fin-6560e3fbfa
source_url: 'https://mordovia.roskazna.gov.ru/'
...
description: >-
  ...
  учет и распределение поступлений, бюджетный учет и отчетность, открытие и
...
# Республика Мордовия: УФК по Республике Мордовия
...
| Оператор | УФК по Республике Мордовия |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация об обеспечении наличными, учет и распределение поступлений, бюджетный учет и отчетность, открытие и ведение лицевых счетов
...
**Категория (таблица):** Официальный сайт территориального управления Федерального казначейства

**Статус исследования:** найдено

**Комментарий:** Официальный сайт территориального управления Федерального казначейства по Республике Мордовия.

## Оператор

УФК по Республике Мордовия — канонический вход: https://mordovia.roskazna.gov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://mordovia.roskazna.gov.ru/ | HTML |

## Объекты данных и показатели

- Информация об обеспечении наличными, учет и распределение поступлений, бюджетный учет и отчетность, открытие и ведение лицевых счетов
