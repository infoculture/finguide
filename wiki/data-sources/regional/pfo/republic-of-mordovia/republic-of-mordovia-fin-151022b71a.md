---
title: >-
  Республика Мордовия: Территориальный фонд обязательного медицинского
...
slug: /data-sources/regional/republic-of-mordovia-fin-151022b71a
source_url: 'http://www.tfomsrm.ru/'
...
description: >-
  ...
  ОМС): Информация о деятельности фонда, нормативные документы (сайт временно
  недоступен)
...
# Республика Мордовия: Территориальный фонд обязательного медицинского страхования Республики Мордовия
...
| Оператор | Территориальный фонд обязательного медицинского страхования Республики Мордовия |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о деятельности фонда, нормативные документы (сайт временно недоступен)
...
**Комментарий:** Сайт выдает ошибку базы данных. Не удалось получить информацию о финансовых данных.

## Оператор

Территориальный фонд обязательного медицинского страхования Республики Мордовия — канонический вход: http://www.tfomsrm.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://www.tfomsrm.ru/ | HTML |

## Объекты данных и показатели

- Информация о деятельности фонда, нормативные документы (сайт временно недоступен)
