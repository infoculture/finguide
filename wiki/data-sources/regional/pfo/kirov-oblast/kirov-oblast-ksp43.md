---
title: 'Кировская область: Контрольно-счетная палата Кировской области'
sidebar_label: Контрольно-счетная палата Кировской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/kirov-oblast-fin-ce745c9a11
source_url: 'http://www.ksp43.ru/'
...
description: >-
  ...
  госфинансам): Отчеты о контрольной и экспертно-аналитической деятельности,
  аудиты
...
# Кировская область: Контрольно-счетная палата Кировской области
...
| Оператор | Контрольно-счетная палата Кировской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Отчеты о контрольной и экспертно-аналитической деятельности, аудиты
...
Контрольно-счетная палата Кировской области — канонический вход: http://www.ksp43.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://www.ksp43.ru/ | HTML |

## Объекты данных и показатели

- Отчеты о контрольной и экспертно-аналитической деятельности, аудиты
