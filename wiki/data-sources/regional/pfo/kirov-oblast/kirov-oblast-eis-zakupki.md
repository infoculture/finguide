---
title: 'Кировская область: Портал закупок'
sidebar_label: Портал закупок
tags:
  - data-source
  - regional
  - budget
...
# Кировская область: Портал закупок
...
**Комментарий:** Федеральный портал с данными по госзакупкам.
