---
title: 'Кировская область: Открытый бюджет (раздел на сайте Минфина)'
sidebar_label: Открытый бюджет (раздел на сайте Минфина)
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/kirov-oblast-fin-abe9296291
source_url: 'https://www.minfin.kirov.ru/otkrytyy-byudzhet'
...
description: >-
  ...
  для граждан): Бюджет для граждан, консолидированный бюджет, исполнение
  муниципальных бюджетов, областной бюджет
...
# Кировская область: Открытый бюджет (раздел на сайте Минфина)
...
| Оператор | Открытый бюджет (раздел на сайте Минфина) |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Бюджет для граждан, консолидированный бюджет, исполнение муниципальных бюджетов, областной бюджет
...
**Комментарий:** Отдельный раздел на сайте Министерства финансов.

## Оператор

Открытый бюджет (раздел на сайте Минфина) — канонический вход: https://www.minfin.kirov.ru/otkrytyy-byudzhet

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://www.minfin.kirov.ru/otkrytyy-byudzhet | HTML |

## Объекты данных и показатели

- Бюджет для граждан, консолидированный бюджет, исполнение муниципальных бюджетов, областной бюджет
