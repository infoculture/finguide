---
title: 'Кировская область: ТФОМС Кировской области'
sidebar_label: ТФОМС Кировской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/kirov-oblast-fin-5118765b7b
source_url: 'https://kotfoms.kirov.ru/'
...
description: >-
  ...
  ОМС): Информация по обязательному медицинскому страхованию, тарифы,
...
# Кировская область: ТФОМС Кировской области
...
| Оператор | ТФОМС Кировской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация по обязательному медицинскому страхованию, тарифы, нормативные документы
...
**Комментарий:** Содержит данные о финансовом обеспечении ОМС.

## Оператор

ТФОМС Кировской области — канонический вход: https://kotfoms.kirov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://kotfoms.kirov.ru/ | HTML |

## Объекты данных и показатели

- Информация по обязательному медицинскому страхованию, тарифы, нормативные документы
