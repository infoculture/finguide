...
slug: /data-sources/regional/kaliningrad-oblast-fin-b197b53a76
...
description: >-
  ...
  база): Правовые акты Калининградской области
...
# Калининградская область: Портал Правительства Калининградской области (раздел "Правовые акты")
...
| Оператор | Портал Правительства Калининградской области (раздел "Правовые акты") |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Правовые акты Калининградской области
...
**Комментарий:** Размещение правовых актов носит информативный характер

## Оператор

Портал Правительства Калининградской области (раздел "Правовые акты") — канонический вход: https://gov39.ru/working/npa

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://gov39.ru/working/npa | HTML |
