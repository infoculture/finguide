---
title: 'город Санкт-Петербург: Открытый бюджет Санкт-Петербурга'
sidebar_label: Открытый бюджет Санкт-Петербурга
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/saint-petersburg-fin-82a845f7fd
...
description: >-
  ...
  для граждан): Информация о бюджете города в доступной форме, аналитика,
  инфографика
...
# город Санкт-Петербург: Открытый бюджет Санкт-Петербурга
...
| Оператор | Открытый бюджет Санкт-Петербурга |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о бюджете города в доступной форме, аналитика, инфографика
...
Открытый бюджет Санкт-Петербурга — канонический вход: https://budget.gov.spb.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://budget.gov.spb.ru/ | HTML |

## Объекты данных и показатели

- Информация о бюджете города в доступной форме, аналитика, инфографика
