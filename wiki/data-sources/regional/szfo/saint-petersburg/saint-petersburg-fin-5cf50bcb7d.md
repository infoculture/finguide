---
title: 'город Санкт-Петербург: Портал открытых данных Санкт-Петербурга'
sidebar_label: Портал открытых данных Санкт-Петербурга
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/saint-petersburg-fin-5cf50bcb7d
source_url: >-
...
description: >-
  Автоимпорт из _dev/rf_finance_sources_table_full.md (Открытые данные): Наборы
  открытых данных, включая финансовые
...
# город Санкт-Петербург: Портал открытых данных Санкт-Петербурга
...
Портал открытых данных Санкт-Петербурга — канонический вход: https://www.gov.spb.ru/gov/otrasl/c_information/napravlenie-deyatelnosti-komiteta/otkrytye-dannye

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://www.gov.spb.ru/gov/otrasl/c_information/napravlenie-deyatelnosti-komiteta/otkrytye-dannye | HTML |

## Объекты данных и показатели

- Наборы открытых данных, включая финансовые
