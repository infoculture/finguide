---
title: 'Псковская область: Открытый бюджет Псковской области'
sidebar_label: Открытый бюджет Псковской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/pskov-oblast-fin-a00f5716bd
source_url: 'http://bks.pskov.ru/ebudget'
...
description: >-
  ...
  для граждан): Упрощенная информация о бюджете для широкой аудитории,
  исполнение бюджета, доходы, расходы
...
# Псковская область: Открытый бюджет Псковской области
...
| Оператор | Открытый бюджет Псковской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Упрощенная информация о бюджете для широкой аудитории, исполнение бюджета, доходы, расходы
...
**Комментарий:** Также есть раздел "Бюджет для граждан" на сайте Минфина: https://finance.pskov.ru/ob-upravlenii/byudzhet-dlya-grazhdan

## Оператор

Открытый бюджет Псковской области — канонический вход: http://bks.pskov.ru/ebudget

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://bks.pskov.ru/ebudget | HTML |

## Объекты данных и показатели

- Упрощенная информация о бюджете для широкой аудитории, исполнение бюджета, доходы, расходы
