---
title: 'Псковская область: Псковстат'
sidebar_label: Псковстат
tags:
  - data-source
  - regional
  - statistics
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/pskov-oblast-fin-8c9f789a26
...
description: >-
  ...
  включая финансовые показатели (ВРП, доходы, расходы, занятость)
...
Коротко: Статистические данные о социально-экономическом развитии региона, включая финансовые показатели (ВРП, доходы, расходы, занятость)
...
| --- | --- | --- |
| Веб | https://60.rosstat.gov.ru/ | HTML |

## Объекты данных и показатели

- Статистические данные о социально-экономическом развитии региона, включая финансовые показатели (ВРП, доходы, расходы, занятость)
