---
title: 'Псковская область: Нормативные правовые акты Псковской области'
sidebar_label: Нормативные правовые акты Псковской области
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/pskov-oblast-fin-0b1091de55
...
description: >-
  ...
  база): Законы и постановления, в том числе касающиеся бюджета и финансов
...
# Псковская область: Нормативные правовые акты Псковской области
...
| Оператор | Нормативные правовые акты Псковской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Законы и постановления, в том числе касающиеся бюджета и финансов
...
Нормативные правовые акты Псковской области — канонический вход: https://pravo.pskov.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://pravo.pskov.ru/ | HTML |

## Объекты данных и показатели

- Законы и постановления, в том числе касающиеся бюджета и финансов
