...
sidebar_label: Министерство финансов Республики Коми
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/republic-of-komi-fin-98394e0e0d
...
description: >-
  ...
  субъекта): Бюджет, отчетность, нормативные акты
...
Коротко: Бюджет, отчетность, нормативные акты
...
**Комментарий:** Сайт недоступен в момент проверки, но URL подтвержден
...
| --- | --- | --- |
| Веб | https://minfin.rkomi.ru/ | HTML |

## Объекты данных и показатели

- Бюджет, отчетность, нормативные акты
