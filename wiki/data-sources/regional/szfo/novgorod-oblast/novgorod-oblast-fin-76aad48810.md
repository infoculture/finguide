---
title: >-
  Новгородская область: Открытый бюджет для граждан (на сайте Администрации
  Великого Новгорода)
sidebar_label: 'Открытый бюджет для граждан (на сайте Администрации '
tags:
  - data-source
  - regional
  - budget
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/novgorod-oblast-fin-76aad48810
source_url: 'http://www.adm.nov.ru/view.xhtml?nid=207'
...
description: >-
  ...
  для граждан): Бюджет для граждан по отчету об исполнении бюджета Великого
  Новгорода
...
# Новгородская область: Открытый бюджет для граждан (на сайте Администрации Великого Новгорода)
...
| Оператор | Открытый бюджет для граждан (на сайте Администрации Великого Новгорода) |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Бюджет для граждан по отчету об исполнении бюджета Великого Новгорода
...
**Комментарий:** Информация о муниципальном бюджете Великого Новгорода.

## Оператор

Открытый бюджет для граждан (на сайте Администрации Великого Новгорода) — канонический вход: http://www.adm.nov.ru/view.xhtml?nid=207

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://www.adm.nov.ru/view.xhtml?nid=207 | HTML |

## Объекты данных и показатели

- Бюджет для граждан по отчету об исполнении бюджета Великого Новгорода
