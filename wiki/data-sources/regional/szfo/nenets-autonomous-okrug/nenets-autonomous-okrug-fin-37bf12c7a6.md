...
slug: /data-sources/regional/nenets-autonomous-okrug-fin-37bf12c7a6
...
description: >-
  ...
  для граждан): Презентации и проекты законов об окружном бюджете для граждан
...
# Ненецкий автономный округ: Департамент финансов Ненецкого автономного округа (раздел «Бюджет для граждан»)
...
| Оператор | Департамент финансов Ненецкого автономного округа (раздел «Бюджет для граждан») |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Презентации и проекты законов об окружном бюджете для граждан
...
Департамент финансов Ненецкого автономного округа (раздел «Бюджет для граждан») — канонический вход: https://dfei.adm-nao.ru/byudzhet-dlya-grazhdan

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | https://dfei.adm-nao.ru/byudzhet-dlya-grazhdan | HTML |

## Объекты данных и показатели

- Презентации и проекты законов об окружном бюджете для граждан
