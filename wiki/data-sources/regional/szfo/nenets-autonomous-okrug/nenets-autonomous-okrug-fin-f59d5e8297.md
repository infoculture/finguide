...
slug: /data-sources/regional/nenets-autonomous-okrug-fin-f59d5e8297
...
description: >-
  ...
  ОМС): Нормативные документы, информация о системе ОМС, финансовые отчеты
  (предполагается)
...
# Ненецкий автономный округ: Территориальный фонд обязательного медицинского страхования Ненецкого автономного округа
...
Коротко: Нормативные документы, информация о системе ОМС, финансовые отчеты (предполагается)
...
**Комментарий:** Содержит информацию о деятельности фонда ОМС.
...
| --- | --- | --- |
| Веб | https://wp.ofomsnao.ru/ | HTML |

## Объекты данных и показатели

- Нормативные документы, информация о системе ОМС, финансовые отчеты (предполагается)
