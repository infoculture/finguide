---
title: 'Мурманская область: Контрольно-Счетная Палата Мурманской области'
sidebar_label: Контрольно-Счетная Палата Мурманской области
tags:
  - data-source
  - regional
  - control
last_updated: 2026-05-14T00:00:00.000Z
slug: /data-sources/regional/murmansk-oblast-fin-d0472baf28
source_url: 'http://kspmo.ru/'
...
description: >-
  ...
  орган): Информация о контрольной деятельности, результаты проверок соблюдения
...
# Мурманская область: Контрольно-Счетная Палата Мурманской области
...
| Оператор | Контрольно-Счетная Палата Мурманской области |
| Режим доступа | Открытый (по состоянию на дату импорта; перед автоматизацией проверьте robots/ограничения) |

Коротко: Информация о контрольной деятельности, результаты проверок соблюдения бюджетного законодательства.
...
**Комментарий:** Официальный сайт региональной контрольно-счетной палаты.

## Оператор

Контрольно-Счетная Палата Мурманской области — канонический вход: http://kspmo.ru/

## URL и точки доступа

| Тип доступа | URL | Формат |
| --- | --- | --- |
| Веб | http://kspmo.ru/ | HTML |

## Объекты данных и показатели

- Информация о контрольной деятельности, результаты проверок соблюдения бюджетного законодательства.
