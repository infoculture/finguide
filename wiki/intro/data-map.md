...
description: Типовые маршруты от вопроса к глоссарию, ИС, источникам данных, отчётности и практическим инструкциям.
category: intro
...
Эта страница — «надстройка» над разделами книги: куда идти, если нужно **определение**, **систему**, **файл с данными**, **форму** или **пример кода**. Подробнее о разделах — в [Как пользоваться базой знаний](./how-to-use.md).
...
3. Нормативка — [Нормативная база](/legal/), чаще всего [Бюджетный кодекс](/legal/budget-code) и приказы по классификации ([заказы Минфина по КБК и КОСГУ](/legal/budget-classification-orders)).
