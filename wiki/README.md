...
## Для редакторов и инструментов ИИ

- Правила оформления карточек и перекрёстных ссылок — в [AGENTS.md](https://github.com/infoculture/finguide/blob/master/AGENTS.md) в репозитории книги.
- Ориентация по разделам и канонические URL — в [Как пользоваться базой знаний](/intro/how-to-use) и на странице [Карта данных](/intro/data-map).
- Участие и соглашения о ссылках — в [CONTRIBUTING.md](https://github.com/infoculture/finguide/blob/master/CONTRIBUTING.md).
