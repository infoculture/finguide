...
- Правила оформления карточек и перекрёстных ссылок — в [AGENTS.md](https://github.com/infoculture/opengovfinancesbook/blob/master/AGENTS.md) в репозитории книги.
...
- Участие и соглашения о ссылках — в [CONTRIBUTING.md](https://github.com/infoculture/opengovfinancesbook/blob/master/CONTRIBUTING.md).
