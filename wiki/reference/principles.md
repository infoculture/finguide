...
description: "Тринадцать принципов бюджетной системы РФ по Бюджетному кодексу: кратко официальные формулировки и пояснения простым языком."
tags: [reference, howto, knowledge-base]
