---
title: "РОССИЙСКИЙ ФОНД РАЗВИТИЯ ИНФОРМАЦИОННЫХ ТЕХНОЛОГИЙ"
sidebar_label: "РФРИТ"
tags:
  - organizations
  - federal
...
slug: /organizations/federal-gos-nko/rfrit
content_type: organization
entity_type: organization
source_url: "https://rfrit.ru/"
org_kind: federal_gos_ngo
inn: "9710077036"
description: "РОССИЙСКИЙ ФОНД РАЗВИТИЯ ИНФОРМАЦИОННЫХ ТЕХНОЛОГИЙ: федеральная госНКО (срез 2020), учредитель и субсидии; открытые данные — в парной карточке источника."
related_pages:
  - /data-sources/federal/rfrit-disclosure
...
Коротко: **РФРИТ** — [федеральная госНКО](/glossary/gosudarstvennye-nko) в срезе исследования **GovNGO 2020**; для идентификации, субсидий (2017–2020 (исследование GovNGO, ноябрь 2020)) и ссылок на реестры используйте **[карточку источника](/data-sources/federal/rfrit-disclosure)**.
...
| Учредитель (субсидии, срез) | Минцифры России |
| Уровень | Федеральный |
...
- [РФРИТ: открытые данные](/data-sources/federal/rfrit-disclosure)
- Официальный сайт — https://rfrit.ru/
- Отчётность и раскрытие — https://rfrit.ru/about/
- [ЕГРЮЛ](/information-systems/federal/egrul) — учредительные данные по ИНН 9710077036
