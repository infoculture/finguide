---
title: "ГОСУДАРСТВЕННАЯ КОРПОРАЦИЯ ПО СОДЕЙСТВИЮ РАЗРАБОТКЕ, ПРОИЗВОДСТВУ И ЭКСПОРТУ ВЫСОКОТЕХНОЛОГИЧНОЙ ПРОМЫШЛЕННОЙ ПРОДУКЦИИ \"РОСТЕХ\""
sidebar_label: "ГК по содействию разработке и производству"
tags:
  - organizations
  - federal
  - programs
last_updated: 2026-05-16T00:00:00.000Z
slug: /organizations/federal-gos-nko/gk-razrabotka-proizvodstvo
content_type: organization
entity_type: organization
source_url: "https://rostec.ru/"
org_kind: federal_gos_ngo
inn: "7704274402"
description: "ГОСУДАРСТВЕННАЯ КОРПОРАЦИЯ ПО СОДЕЙСТВИЮ РАЗРАБОТКЕ, ПРОИЗВОДСТВУ И ЭКСПОРТУ ВЫСОКОТЕХНОЛОГИЧНОЙ ПРОМЫШЛЕННОЙ ПРОДУКЦИИ \"РОСТЕХ\": федеральная госНКО (срез 2020), учредитель и субсидии; открытые данные — в парной карточке источника."
related_pages:
  - /data-sources/federal/gk-razrabotka-proizvodstvo-disclosure
...
Коротко: **ГК по содействию разработке и производству** — [федеральная госНКО](/glossary/gosudarstvennye-nko) в срезе исследования **GovNGO 2020**; для идентификации, субсидий (2017–2020 (исследование GovNGO, ноябрь 2020)) и ссылок на реестры используйте **[карточку источника](/data-sources/federal/gk-razrabotka-proizvodstvo-disclosure)**.

| Признак | Значение |
| :--- | :--- |
| Краткое имя | ГК по содействию разработке и производству |
| ИНН | 7704274402 |
| Правовой тип (таблица) | государственная компания / корпорация (классификация субсидий) |
| Учредитель (субсидии, срез) | Правительство РФ |
| Уровень | Федеральный |
...
- [ГК по содействию разработке и производству: открытые данные](/data-sources/federal/gk-razrabotka-proizvodstvo-disclosure)
- Официальный сайт — https://rostec.ru/
- Отчётность и раскрытие — https://rostec.ru/investors/reports/
- [ЕГРЮЛ](/information-systems/federal/egrul) — учредительные данные по ИНН 7704274402
