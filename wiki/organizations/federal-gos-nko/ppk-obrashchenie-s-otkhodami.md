---
title: "ПУБЛИЧНО-ПРАВОВАЯ КОМПАНИЯ ПО ФОРМИРОВАНИЮ КОМПЛЕКСНОЙ СИСТЕМЫ ОБРАЩЕНИЯ С ТВЕРДЫМИ КОММУНАЛЬНЫМИ ОТХОДАМИ \"РОССИЙСКИЙ ЭКОЛОГИЧЕСКИЙ ОПЕРАТОР\""
sidebar_label: "ППК по обращению с отходами"
tags:
  - organizations
  - federal
  - programs
last_updated: 2026-05-16T00:00:00.000Z
slug: /organizations/federal-gos-nko/ppk-obrashchenie-s-otkhodami
content_type: organization
entity_type: organization
source_url: "https://reo.ru/"
org_kind: federal_gos_ngo
inn: "7703474222"
description: "ПУБЛИЧНО-ПРАВОВАЯ КОМПАНИЯ ПО ФОРМИРОВАНИЮ КОМПЛЕКСНОЙ СИСТЕМЫ ОБРАЩЕНИЯ С ТВЕРДЫМИ КОММУНАЛЬНЫМИ ОТХОДАМИ \"РОССИЙСКИЙ ЭКОЛОГИЧЕСКИЙ ОПЕРАТОР\": федеральная госНКО (срез 2020), учредитель и субсидии; открытые данные — в парной карточке источника."
related_pages:
...
Коротко: **ППК по обращению с отходами** — [федеральная госНКО](/glossary/gosudarstvennye-nko) в срезе исследования **GovNGO 2020**; для идентификации, субсидий (2017–2020 (исследование GovNGO, ноябрь 2020)) и ссылок на реестры используйте **[карточку источника](/data-sources/federal/ppk-obrashchenie-s-otkhodami-disclosure)**.

| Признак | Значение |
| :--- | :--- |
| Краткое имя | ППК по обращению с отходами |
| ИНН | 7703474222 |
| Правовой тип (таблица) | публично-правовая компания / гос НКО |
| Учредитель (субсидии, срез) | Минприроды России |
| Уровень | Федеральный |
...
- [ППК по обращению с отходами: открытые данные](/data-sources/federal/ppk-obrashchenie-s-otkhodami-disclosure)
- Официальный сайт — https://reo.ru/
- Отчётность и раскрытие — https://reo.ru/about/
- [ЕГРЮЛ](/information-systems/federal/egrul) — учредительные данные по ИНН 7703474222
