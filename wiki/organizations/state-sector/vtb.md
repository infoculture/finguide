---
title: "Банк ВТБ (публичное акционерное общество)"
sidebar_label: "ВТБ"
tags:
  - organizations
  - federal
...
slug: /organizations/vtb
content_type: organization
entity_type: organization
source_url: "https://www.vtb.ru/"
org_kind: other
description: "Банк ВТБ (публичное акционерное общество): правовой статус (крупнейший госбанк / публичное АО), роль в корпоративном раскрытии и связь с открытыми финансовыми данными; витрины отчётности — в парной карточке источника."
related_pages:
  - /data-sources/federal/vtb-disclosure
...
Коротко: **ВТБ** (крупнейший госбанк / публичное АО) — субъект **сектора госучастия** с **корпоративным** (не казённым) контуром отчётности; для витрин раскрытия, закупок и показателей деятельности используйте парную карточку **[источника](/data-sources/federal/vtb-disclosure)**, для бюджетного следа — **[ЕИС](/data-sources/federal/procurement)** и **[субсидии](/data-sources/federal/subsidy)**.
...
- Полный перечень разделов: **[ВТБ: отчётность и раскрытие](/data-sources/federal/vtb-disclosure)**
...
- [ВТБ: отчётность и раскрытие](/data-sources/federal/vtb-disclosure) — таблицы URL по категориям.
