---
title: "Публично-правовая компания \"Фонд развития территорий\""
sidebar_label: "ФРТ"
tags:
  - organizations
  - federal
...
slug: /organizations/fond-razvitiya-territoriy
content_type: organization
entity_type: organization
source_url: "https://xn--p1aee.xn--p1ai/"
org_kind: other
description: "Публично-правовая компания \"Фонд развития территорий\": правовой статус (публично-правовая компания / гос НКО), роль в корпоративном раскрытии и связь с открытыми финансовыми данными; витрины отчётности — в парной карточке источника."
related_pages:
...
- https://xn--p1aee.xn--p1ai/
- Полный перечень разделов: **[ФРТ: отчётность и раскрытие](/data-sources/federal/fond-razvitiya-territoriy-disclosure)**
...
- [ФРТ: отчётность и раскрытие](/data-sources/federal/fond-razvitiya-territoriy-disclosure) — таблицы URL по категориям.
