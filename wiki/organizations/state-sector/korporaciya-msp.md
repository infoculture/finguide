---
title: "Акционерное общество \"Корпорация МСП\""
sidebar_label: "Корпорация МСП"
tags:
  - organizations
  - federal
  - programs
last_updated: 2026-05-15T00:00:00.000Z
slug: /organizations/korporaciya-msp
content_type: organization
entity_type: organization
source_url: "https://corpmsp.ru/"
org_kind: other
description: "Акционерное общество \"Корпорация МСП\": правовой статус (федеральный институт развития / госкомпания), роль в корпоративном раскрытии и связь с открытыми финансовыми данными; витрины отчётности — в парной карточке источника."
related_pages:
...
Коротко: **Корпорация МСП** (федеральный институт развития / госкомпания) — субъект **сектора госучастия** с **корпоративным** (не казённым) контуром отчётности; для витрин раскрытия, закупок и показателей деятельности используйте парную карточку **[источника](/data-sources/federal/korporaciya-msp-disclosure)**, для бюджетного следа — **[ЕИС](/data-sources/federal/procurement)** и **[субсидии](/data-sources/federal/subsidy)**.

| Признак | Значение |
| :--- | :--- |
| Краткое имя | Корпорация МСП |
| Правовой тип (таблица) | федеральный институт развития / госкомпания |
| Официальный сайт | https://corpmsp.ru/ |
| Уровень | Федеральный |
...
- https://corpmsp.ru/
- Полный перечень разделов: **[Корпорация МСП: отчётность и раскрытие](/data-sources/federal/korporaciya-msp-disclosure)**
...
- [Корпорация МСП: отчётность и раскрытие](/data-sources/federal/korporaciya-msp-disclosure) — таблицы URL по категориям.
