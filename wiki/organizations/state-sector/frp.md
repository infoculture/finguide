---
title: "Фонд развития промышленности (ФРП)"
sidebar_label: "ФРП"
tags:
  - organizations
  - federal
...
slug: /organizations/frp
content_type: organization
entity_type: organization
source_url: "https://frprf.ru/"
org_kind: other
description: "Фонд развития промышленности (ФРП): правовой статус (государственный фонд / гос НКО), роль в корпоративном раскрытии и связь с открытыми финансовыми данными; витрины отчётности — в парной карточке источника."
related_pages:
  - /data-sources/federal/frp-disclosure
...
Коротко: **ФРП** (государственный фонд / гос НКО) — субъект **сектора госучастия** с **корпоративным** (не казённым) контуром отчётности; для витрин раскрытия, закупок и показателей деятельности используйте парную карточку **[источника](/data-sources/federal/frp-disclosure)**, для бюджетного следа — **[ЕИС](/data-sources/federal/procurement)** и **[субсидии](/data-sources/federal/subsidy)**.

| Признак | Значение |
| :--- | :--- |
| Краткое имя | ФРП |
| Правовой тип (таблица) | государственный фонд / гос НКО |
| Официальный сайт | https://frprf.ru/ |
| Уровень | Федеральный |
...
- https://frprf.ru/
- Полный перечень разделов: **[ФРП: отчётность и раскрытие](/data-sources/federal/frp-disclosure)**
...
- [ФРП: отчётность и раскрытие](/data-sources/federal/frp-disclosure) — таблицы URL по категориям.
