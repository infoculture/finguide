---
title: "Публично-правовая компания \"Военно-строительная компания\" (ВСК)"
sidebar_label: "ВСК"
tags:
  - organizations
  - federal
...
slug: /organizations/vsk-ppk
content_type: organization
entity_type: organization
source_url: "https://vskmo.ru/"
org_kind: other
description: "Публично-правовая компания \"Военно-строительная компания\" (ВСК): правовой статус (публично-правовая компания / гос НКО), роль в корпоративном раскрытии и связь с открытыми финансовыми данными; витрины отчётности — в парной карточке источника."
related_pages:
  - /data-sources/federal/vsk-ppk-disclosure
...
# Публично-правовая компания "Военно-строительная компания" (ВСК)

Коротко: **ВСК** (публично-правовая компания / гос НКО) — субъект **сектора госучастия** с **корпоративным** (не казённым) контуром отчётности; для витрин раскрытия, закупок и показателей деятельности используйте парную карточку **[источника](/data-sources/federal/vsk-ppk-disclosure)**, для бюджетного следа — **[ЕИС](/data-sources/federal/procurement)** и **[субсидии](/data-sources/federal/subsidy)**.

| Признак | Значение |
| :--- | :--- |
| Краткое имя | ВСК |
| Правовой тип (таблица) | публично-правовая компания / гос НКО |
| Официальный сайт | https://vskmo.ru/ |
| Уровень | Федеральный |
...
- https://vskmo.ru/
- Полный перечень разделов: **[ВСК: отчётность и раскрытие](/data-sources/federal/vsk-ppk-disclosure)**
...
- [ВСК: отчётность и раскрытие](/data-sources/federal/vsk-ppk-disclosure) — таблицы URL по категориям.
