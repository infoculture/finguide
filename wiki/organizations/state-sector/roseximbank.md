---
title: "Российский экспортно-импортный банк (Росэксимбанк)"
sidebar_label: "Росэксимбанк"
tags:
  - organizations
  - federal
  - programs
last_updated: 2026-05-15T00:00:00.000Z
slug: /organizations/roseximbank
content_type: organization
entity_type: organization
source_url: "https://www.eximbank.ru/"
org_kind: other
description: "Российский экспортно-импортный банк (Росэксимбанк): правовой статус (федеральный институт развития / госбанк), роль в корпоративном раскрытии и связь с открытыми финансовыми данными; витрины отчётности — в парной карточке источника."
related_pages:
...
Коротко: **Росэксимбанк** (федеральный институт развития / госбанк) — субъект **сектора госучастия** с **корпоративным** (не казённым) контуром отчётности; для витрин раскрытия, закупок и показателей деятельности используйте парную карточку **[источника](/data-sources/federal/roseximbank-disclosure)**, для бюджетного следа — **[ЕИС](/data-sources/federal/procurement)** и **[субсидии](/data-sources/federal/subsidy)**.

| Признак | Значение |
| :--- | :--- |
| Краткое имя | Росэксимбанк |
| Правовой тип (таблица) | федеральный институт развития / госбанк |
| Официальный сайт | https://www.eximbank.ru/ |
| Уровень | Федеральный |

## Роль в данных и учёте

Организация публикует **корпоративную** отчётность и раскрытия по правилам эмитента / специального статуса (**федеральный институт развития / госбанк**). Показатели **не** сводятся напрямую к строкам **[федерального бюджета](/data-sources/federal/minfin-fedbud-execute)** или **[форм учреждений](/reporting/institution-financial-statements)**. Связь с бюджетом — через **субсидии**, **госпрограммы**, **дивиденды** и **закупки**; трассируйте по **[223-ФЗ](/legal/223-fz)** / **[44-ФЗ](/legal/44fz)** и открытым реестрам.
...
- https://www.e-disclosure.ru/portal/company-1012/otchyotnost-kompanii
- Полный перечень разделов: **[Росэксимбанк: отчётность и раскрытие](/data-sources/federal/roseximbank-disclosure)**
...
- [Росэксимбанк: отчётность и раскрытие](/data-sources/federal/roseximbank-disclosure) — таблицы URL по категориям.
