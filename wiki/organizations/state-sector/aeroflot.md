---
title: "Публичное акционерное общество \"Аэрофлот\""
sidebar_label: "Аэрофлот"
tags:
  - organizations
  - federal
  - programs
last_updated: 2026-05-15T00:00:00.000Z
slug: /organizations/aeroflot
content_type: organization
entity_type: organization
source_url: "https://www.aeroflot.ru/"
org_kind: other
description: "Публичное акционерное общество \"Аэрофлот\": правовой статус (крупнейшая госкомпания / публичное АО), роль в корпоративном раскрытии и связь с открытыми финансовыми данными; витрины отчётности — в парной карточке источника."
related_pages:
  - /data-sources/federal/aeroflot-disclosure
...
Коротко: **Аэрофлот** (крупнейшая госкомпания / публичное АО) — субъект **сектора госучастия** с **корпоративным** (не казённым) контуром отчётности; для витрин раскрытия, закупок и показателей деятельности используйте парную карточку **[источника](/data-sources/federal/aeroflot-disclosure)**, для бюджетного следа — **[ЕИС](/data-sources/federal/procurement)** и **[субсидии](/data-sources/federal/subsidy)**.

| Признак | Значение |
| :--- | :--- |
| Краткое имя | Аэрофлот |
...
- Полный перечень разделов: **[Аэрофлот: отчётность и раскрытие](/data-sources/federal/aeroflot-disclosure)**
...
- [Аэрофлот: отчётность и раскрытие](/data-sources/federal/aeroflot-disclosure) — таблицы URL по категориям.
